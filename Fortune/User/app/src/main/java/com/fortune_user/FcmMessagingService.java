...
public class FcmMessagingService extends FirebaseMessagingService {
    ...
    public void generate_neworder() {
        ...
        if (VERSION.SDK_INT < 26) {
            Notification notification = new Builder(this).setSmallIcon(R.drawable.smallogo).setContentIntent(pendingIntent).setContent(contentView).build();
        ...
        else
        {
            ...
            Notification notification2 = new Builder(this, str).setSmallIcon(R.drawable.smallogo).setContentIntent(pendingIntent).setContent(contentView).setPriority(0).build();
