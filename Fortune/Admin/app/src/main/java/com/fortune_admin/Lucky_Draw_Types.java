...
public class Lucky_Draw_Types extends AppCompatActivity {
    ...
    public int limit = 0;
    ListView list;
    public LuckyDrawBatches_ListAdapter listAdapter;
    ImageView nodata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lucky__draw__types);
        ...
        text.setText("LuckyDraw Batches");
        text.setTypeface(face);
        Glide.with(this).load(R.drawable.loading).into(heart);
        feedItems = new ArrayList();
        listAdapter = new LuckyDrawBatches_ListAdapter(this, feedItems);
    ...
    public class loadstatus extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            try {
                String link=Temp.weblink+"getluckydrawbatches.php";
