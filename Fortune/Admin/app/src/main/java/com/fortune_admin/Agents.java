...
import adapter.Agents_ListAdapter;
...
public class Agents extends AppCompatActivity {
    ...
    public int limit = 0;
    ListView list;
    public Agents_ListAdapter listAdapter;
    ImageView nodata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listAdapter = new Agents_ListAdapter(this, feedItems);
    ...
    public class loadstatus extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            try {
                String link=Temp.weblink+"getagents.php";
        ...
        public void onPostExecute(String result) {
            try {
                if (result.contains(":%ok")) {
                    ...
                    int m = -1;
                    for (int i = 1; i <= k; i++) {
                        AgentList_FeedItem item = new AgentList_FeedItem();
                        m=m+1;
                        item.setSn(got[m]);
                        m=m+1;
                        item.setName(got[m]);
