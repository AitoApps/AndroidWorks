...
public class News_ListAdapter extends BaseAdapter {
    ...
    Typeface face;
    public List<News_FeedItem> feedItems;
    private LayoutInflater inflater;
    public String pcatid = "";
    ProgressDialog pd;
    int pos = 0;
    public News_ListAdapter(Activity activity2, List<News_FeedItem> feedItems2) {
        activity = activity2;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.custome_news, null);
        }
        ...
        News_FeedItem item = (News_FeedItem) feedItems.get(position);
        ...
        delete.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                try {
                    ...
                    pcatid = item.getSn();
                     pos = position;
                   showalert_delete("Are you sure want to delete this News ?");
                } catch (Exception e) {
                }
            }
        });
        edit.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                News_FeedItem item = (News_FeedItem) feedItems.get(position);
                Temp.newssn=item.getSn();
                Temp.newshead=item.getHeading();
                Temp.news=item.getNews();
                Temp.newsimgsig=item.getImgsig();
                Temp.newsedit= 1;
                Intent i = new Intent(context, Add_News.class);
    ...
    public class delete_product extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            try {
                String link= Temp.weblink +"delete_news.php";
        ...
        public void onPostExecute(String result) {
            if (pd != null || pd.isShowing()) {
                ...
                if (result.contains("ok")) {
                    ...
                    ((News_List) activity).removeitem(pos);
                    return;
                }
