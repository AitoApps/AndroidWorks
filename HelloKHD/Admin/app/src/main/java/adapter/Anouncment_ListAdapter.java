...
import com.hellokhd_admin.Add_Anouncment;
import com.hellokhd_admin.Add_Mark_Admin;
import com.hellokhd_admin.Anouncments;
...
import data.Announcment_FeedItem;
import data.MarkAdminlist_FeedItem;

public class Anouncment_ListAdapter extends BaseAdapter {
    ...
    Typeface face;
    public List<Announcment_FeedItem> feedItems;
    private LayoutInflater inflater;
    public String pcatid = "";
    ProgressDialog pd;
    int pos = 0;
    public Anouncment_ListAdapter(Activity activity2, List<Announcment_FeedItem> feedItems2) {
        activity = activity2;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.custom_anouncment, null);
        }
        TextView anouncment= (TextView) convertView.findViewById(R.id.anouncment);

        ImageView delete = (ImageView) convertView.findViewById(R.id.delete);
        ImageView edit = (ImageView) convertView.findViewById(R.id.edit);

        Announcment_FeedItem item = (Announcment_FeedItem) feedItems.get(position);


        anouncment.setTypeface(face);

        anouncment.setText(item.getAnouncment());
        ...
        edit.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                Temp.anounid=item.getSn();
                Temp.anouncment=item.getAnouncment();
                Temp.anouncmentedit = 1;
                Intent i = new Intent(context, Add_Anouncment.class);
    ...
    public class delete_product extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            try {
                String link= Temp.weblink +"delete_anouncment.php";
        ...
        public void onPostExecute(String result) {
            if (pd != null || pd.isShowing()) {
                ...
                if (result.contains("ok")) {
                    ...
                    ((Anouncments) activity).removeitem(pos);
                    return;
                }
