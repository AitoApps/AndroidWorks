...
public class Markadminlist_ListAdapter extends BaseAdapter {
    ...
    ProgressDialog pd;
    int pos = 0;
    public Markadminlist_ListAdapter(Activity activity2, List<MarkAdminlist_FeedItem> feedItems2) {
        activity = activity2;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        edit.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                Temp.adminedit = 1;
                Intent i = new Intent(context, Add_Mark_Admin.class);
    ...
    public class delete_product extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            try {
                String link= Temp.weblink +"delete_markadmin.php";
        ...
        public void onPostExecute(String result) {
            if (pd != null || pd.isShowing()) {
                ...
                if (result.contains("ok")) {
                    ...
                    ((MarkAdminList) activity).removeitem(pos);
                    return;
                }
