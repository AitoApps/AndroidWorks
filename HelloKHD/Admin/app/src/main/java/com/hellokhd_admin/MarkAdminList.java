...
public class MarkAdminList extends AppCompatActivity {
    ...
    public int limit = 0;
    ListView list;
    public Markadminlist_ListAdapter listAdapter;
    ImageView nodata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_markadmin__list);
        ...
        addproduct.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Temp.adminedit = 0;
                startActivity(new Intent(getApplicationContext(), Add_Mark_Admin.class));
            }
        });
        ...
        listAdapter = new Markadminlist_ListAdapter(this, feedItems);
    ...
    public class loadstatus extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            ...
            try {
                String link=Temp.weblink +"getmarkadmins.php";
        ...
        public void onPostExecute(String result) {
            try {
                if (result.trim().contains(":%ok")) {
                    ...
                    int m = -1;
                    for (int i = 1; i <= k; i++) {
                        MarkAdminlist_FeedItem item = new MarkAdminlist_FeedItem();
                        m=m+1;
                        item.setSn(got[m].trim());
                        m=m+1;
                        item.setName(got[m]);
                        m=m+1;
                        item.setUsername(got[m]);
                        m=m+1;
                        item.setPassword(got[m]);
                        m=m+1;
