...
import adapter.Cinima_ListAdapter;
...
public class CinemaList extends AppCompatActivity {
    ...
    public int limit = 0;
    ListView list;
    public Cinima_ListAdapter listAdapter;
    ImageView nodata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addproduct.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Temp.cinmaedit = 0;
                startActivity(new Intent(getApplicationContext(), Add_Cinema.class));
            }
        });

        text.setText("Cinima List");
        ...
        listAdapter = new Cinima_ListAdapter(this, feedItems);
    ...
    public class loadstatus extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            ...
            try {
                String link=Temp.weblink +"getcinimalist_admin.php";
        ...
        public void onPostExecute(String result) {
            try {
                if (result.trim().contains(":%ok")) {
                    ...
                    int m = -1;
                    for (int i = 1; i <= k; i++) {
                        Cinema_FeedItem item = new Cinema_FeedItem();
                        m=m+1;
