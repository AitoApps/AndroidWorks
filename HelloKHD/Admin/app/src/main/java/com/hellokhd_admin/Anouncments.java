...
import adapter.Anouncment_ListAdapter;
...
public class Anouncments extends AppCompatActivity {
    ...
    public int limit = 0;
    ListView list;
    public Anouncment_ListAdapter listAdapter;
    ImageView nodata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addproduct.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Temp.anouncmentedit = 0;
                startActivity(new Intent(getApplicationContext(), Add_Anouncment.class));
            }
        });
        ...
        listAdapter = new Anouncment_ListAdapter(this, feedItems);
    ...
    public class loadstatus extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            ...
            try {
                String link=Temp.weblink +"getanounsments.php";
        ...
        public void onPostExecute(String result) {
            try {
                if (result.trim().contains(":%ok")) {
                    ...
                    int m = -1;
                    for (int i = 1; i <= k; i++) {
                        Announcment_FeedItem item = new Announcment_FeedItem();
                        m=m+1;
