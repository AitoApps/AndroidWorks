...
import adapter.News_ListAdapter;
...
public class News_List extends AppCompatActivity {
    ...
    public int limit = 0;
    ListView list;
    public News_ListAdapter listAdapter;
    ImageView nodata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addproduct.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Temp.newsedit = 0;
                startActivity(new Intent(getApplicationContext(), Add_News.class));
            }
        });

        text.setText("News List");
        ...
        listAdapter = new News_ListAdapter(this, feedItems);
    ...
    public class loadstatus extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            ...
            try {
                String link=Temp.weblink +"getnewslist.php";
        ...
        public void onPostExecute(String result) {
            try {
                if (result.trim().contains(":%ok")) {
                    ...
                    int m = -1;
                    for (int i = 1; i <= k; i++) {
                        News_FeedItem item = new News_FeedItem();
                        m=m+1;
