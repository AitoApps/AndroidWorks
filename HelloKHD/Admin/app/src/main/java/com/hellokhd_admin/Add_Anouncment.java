...
public class Add_Anouncment extends AppCompatActivity {
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add__anouncment);
        ...
        anouncment=findViewById(R.id.anouncment);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                } else if (anouncment.getText().toString().equalsIgnoreCase("")) {
                    Toast.makeText(getApplicationContext(), "Please Enter Anouncment", Toast.LENGTH_SHORT).show();
                    anouncment.requestFocus();
                }
                else {
                    uploadingprogress();
                }
    ...
    public void uploadfiletoserver()
    {
        ...
        bodyBuilder.addFormDataPart("isedit", null, RequestBody.create(contentType, Temp.anouncmentedit+""));
        bodyBuilder.addFormDataPart("editsn", null,RequestBody.create(contentType, Temp.anounid));
        bodyBuilder.addFormDataPart("anouncment", null,RequestBody.create(contentType, anouncment.getText().toString()));
        ...
        Request request = new Request.Builder()
                .url(Temp.weblink+"addnewanoucnment.php")
                .post(requestBody)
                .build();
