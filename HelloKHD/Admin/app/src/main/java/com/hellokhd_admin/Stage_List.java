...
public class Stage_List extends AppCompatActivity {
    ...
    public int limit = 0;
    ListView list;
    public Stagelist_ListAdapter listAdapter;
    ImageView nodata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addproduct.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Temp.stagedit = 0;
                startActivity(new Intent(getApplicationContext(), Add_Stage.class));
            }
        });
        text.setText("Stages");
        ...
        listAdapter = new Stagelist_ListAdapter(this, feedItems);
    ...
    public class loadstatus extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            ...
            try {
                String link=Temp.weblink +"getstages_admin.php";
