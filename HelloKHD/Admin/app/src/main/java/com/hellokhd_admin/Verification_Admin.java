...
import adapter.VerificationAdminlist_ListAdapter;
...
public class Verification_Admin extends AppCompatActivity {
    ...
    public int limit = 0;
    ListView list;
    public VerificationAdminlist_ListAdapter listAdapter;
    ImageView nodata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addproduct.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Temp.adedit = 0;
                startActivity(new Intent(getApplicationContext(), Add_VerificationAdmin.class));
            }
        });
        ...
        listAdapter = new VerificationAdminlist_ListAdapter(this, feedItems);
    ...
    public class loadstatus extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            ...
            try {
                String link=Temp.weblink +"getverificationadmins.php";
