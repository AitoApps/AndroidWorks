...
public class DistricSearch_Adapter extends Adapter<ViewHolder> {
    ...
    public List<DistricSearch_FeedItem> feedItems;
    private LayoutInflater inflater;
    public DistricSearch_Adapter(Activity activity2, List<DistricSearch_FeedItem> feedItems2) {
        activity = activity2;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == 0) {
            return new viewHolder(LayoutInflater.from(context).inflate(R.layout.custom_distric_search, parent, false));
        }
        if (viewType == 1) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        if (holder instanceof viewHolder) {
            try {
                DistricSearch_FeedItem item = (DistricSearch_FeedItem) feedItems.get(position);
                ...
                viewHolder2.schoolname.setText(item.getDistricname());
