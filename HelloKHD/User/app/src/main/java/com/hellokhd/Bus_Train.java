    ...
    public void call(final String mob) {
        try {
            ...
            yes.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (ContextCompat.checkSelfPermission(Bus_Train.this, android.Manifest.permission.CALL_PHONE) != 0) {
                        callmob=mob;
                        ActivityCompat.requestPermissions(Bus_Train.this, new String[]{ android.Manifest.permission.CALL_PHONE}, 1);
                    } else {
