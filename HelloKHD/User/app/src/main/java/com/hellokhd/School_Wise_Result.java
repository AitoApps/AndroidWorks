    ...
    public void call(final String mob) {
        try {
            ...
            yes.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (ContextCompat.checkSelfPermission(School_Wise_Result.this, android.Manifest.permission.CALL_PHONE) != 0) {
                        callmob=mob;
                        ActivityCompat.requestPermissions(School_Wise_Result.this, new String[]{ android.Manifest.permission.CALL_PHONE}, 1);
                    } else {
