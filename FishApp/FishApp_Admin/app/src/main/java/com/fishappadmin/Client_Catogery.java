...
import adapter.ClientCatogery_ListAdapter;
...
public class Client_Catogery extends AppCompatActivity {
    ...
    public ClientCatogery_ListAdapter listAdapter;
    ImageView nodata;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listAdapter = new ClientCatogery_ListAdapter(this, feedItems);
    ...
    public class loadstatus extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            try {
                ...
                String link= Temp.weblink +"admin_getclientcatogery.php";
        ...
        public void onPostExecute(String result) {
            try {
                if (result.contains(":%ok")) {
                    ...
                    int m = -1;
                    for (int i = 1; i <= k; i++) {
                        ClientCatgery_FeedItem item = new ClientCatgery_FeedItem();
                        m=m+1;
