...
import adapter.Area_list_ListAdapter;
...
public class Area_Management extends AppCompatActivity {
    ...
    public Area_list_ListAdapter listAdapter;
    ImageView nodata;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.activity_area__management);
        ...
        addproduct.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                Temp.areaedit = 0;
                startActivity(new Intent(getApplicationContext(), Add_Area.class));
            }
        });
        ...
        listAdapter = new Area_list_ListAdapter(this, feedItems);
    ...
    public class loadstatus extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            try {
                ...
                String link= Temp.weblink +"admin_getarealist.php";
        ...
        public void onPostExecute(String result) {
            try {
                if (result.contains(":%ok")) {
                    ...
                    int m = -1;
                    for (int i = 1; i <= k; i++) {
                        Arealist_FeedItem item = new Arealist_FeedItem();
                        m=m+1;
                        item.setSn(got[m].trim());
                        m=m+1;
                        item.setAreaname(got[m]);
                        m=m+1;
                        item.setDeiverytime(got[m]);
                        feedItems.add(item);
                    }
