...
public class Add_Client_Catogery extends AppCompatActivity {
    ImageView back;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.activity_add__client__catogery);
        ...
        photo1.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                try {
                    ...
                    if (!hasPermissions(Add_Client_Catogery.this, PERMISSIONS)) {
                        ActivityCompat.requestPermissions(Add_Client_Catogery.this, PERMISSIONS, PERMISSION_ALL);
                    }
                    else
                    {
        ...
        if (Temp.clientcatedit == 1) {
            ...
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                public void run() {
                    ...
                    apply.load(Temp.weblink+"clientcatogery/"+Temp.clientcatsn+".png").into(new SimpleTarget<Bitmap>() {
        ...
        builder.setItems(options, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int item) {
                if (options[item].equals("Take Photo")) {
                    EasyImage.openCamera(Add_Client_Catogery.this, 1);
                } else if (options[item].equals("Choose from Gallery")) {
                    EasyImage.openGallery(Add_Client_Catogery.this, 1);
        ...
        EasyImage.handleActivityResult(requestCode, resultCode, data2, this, new DefaultCallback() {
            ...
            public void onImagePicked(File imageFile, ImageSource source, int type) {
                ...
                try {
                    ...
                    UCrop.of(Uri.fromFile(imageFile), uri).withOptions(options).withAspectRatio(1.0f, 1.0f).start(Add_Client_Catogery.this);
                } catch (Exception e2) {
                }
            }
        });
    ...
    public void uploadfiletoserver()
    {
        ...
        Request request = new Request.Builder()
                .url(Temp.weblink+"addnewclientcatogery.php")
                .post(requestBody)
                .build();
