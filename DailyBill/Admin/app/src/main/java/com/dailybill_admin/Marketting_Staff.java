...
public class Marketting_Staff extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marketting__staff);
        heart = (ImageView) findViewById(R.id.heart);
        addmarkettingstaff = (ImageView) findViewById(R.id.addmarkettingstaff);
        ...
        text.setText("Marketting Staffs");
        ...
        addmarkettingstaff.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Temp.ismarkettingstaffedit=0;
                startActivity(new Intent(getApplicationContext(),Add_MarkettingStaff.class));
    ...
    public void changeitem(int position, String sn1, String name1, String address1, String idcard1, String mobile1, String place1, String imgsig1, String status1) {
        try {
            feedItems.remove(position);
            listAdapter.notifyDataSetChanged();
            MarkettingStaff_FeedItem item = new MarkettingStaff_FeedItem();
            item.setSn(sn1);
            item.setName(name1);
    ...
    public class loadstatus extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            try {
                String link=Temp.weblink+"admin_getmarkettingstaff.php";
