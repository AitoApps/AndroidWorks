...
import com.dailybill_admin.Add_MarkettingStaff;
import com.dailybill_admin.ConnectionDetecter;
import com.dailybill_admin.DatabaseHandler;
import com.dailybill_admin.Image_Viewer;
import com.dailybill_admin.Marketting_Staff;
...
import data.MarkettingStaff_FeedItem;
...
public class MarkettingStaff_ListAdapter extends BaseAdapter {
    ...
    DatabaseHandler db;
    Typeface face;
    public List<MarkettingStaff_FeedItem> feedItems;
    ...
    public MarkettingStaff_ListAdapter(Activity activity2, List<MarkettingStaff_FeedItem> feedItems2) {
        activity = activity2;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView2 = inflater.inflate(R.layout.custom_markettingstaff, null);
        } else {
        ...
        MarkettingStaff_FeedItem item = (MarkettingStaff_FeedItem) feedItems.get(position);
        ...
        Glide.with(context).load(Temp.weblink+"markettingstaffsmall/"+item.getSn()+".jpg").apply(rep).transition(DrawableTransitionOptions.withCrossFade()).into(image);

        image.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                MarkettingStaff_FeedItem item = (MarkettingStaff_FeedItem) feedItems.get(pos);
                Temp.img_title = item.getName();
                Temp.img_imgsig = item.getImgsig();
                Temp.img_link = Temp.weblink+"markettingstaffpic/"+item.getSn()+".jpg";
        ...
        edit.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                Temp.ismarkettingstaffedit = 1;
                Intent i = new Intent(context, Add_MarkettingStaff.class);
                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                context.startActivity(i);
            }
        });
        disable.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                if (item.getStatus().equalsIgnoreCase("1")) {
                    status1 = "0";
                    showalert_changestatus("Are you sure want to inactive this Marketting Staff ?");
                }
                else
                {
                    status1 = "1";
                    showalert_changestatus("Are you sure want to activate this Marketting Staff?");
                }
    ...
    public class delete_product extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            try {
                String link= Temp.weblink+"admin_deletemarkettingstaff.php";
        ...
        public void onPostExecute(String result) {
            if (pd != null || pd.isShowing()) {
                ...
                if (result.contains("ok")) {
                    ...
                    ((Marketting_Staff) activity).changeitem(pos, sn1,name1, address1, idcard1, mobile1, place1, imgsig1, status1);
                    return;
                }
                Toasty.info(context, Temp.tempproblem, Toast.LENGTH_SHORT).show();
            }
