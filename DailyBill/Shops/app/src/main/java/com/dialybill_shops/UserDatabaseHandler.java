...
public class UserDatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "billmazashopsudb";
    ...
    private static final String shopid = "userid";
    private static final String shopname = "shopname";
    private static final String shopcatogery = "shopcatogery";

    private static String CREATE_TABLE1 = "CREATE TABLE " + TABLE_name1 + "("+pkey +" INTEGER PRIMARY KEY AUTOINCREMENT,"+shopid+" TEXT,"+shopname+" TEXT,"+shopcatogery+" TEXT"+")";
    ...
    public String get_shopcatogery() {
        String link = "";
    ...
    public void adduser(String shopid1,String shopname1,String shopcatogery1) {
        deleteuser();
        SQLiteDatabase db = getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(shopid, shopid1);
        values.put(shopname,shopname1);
        values.put(shopcatogery,shopcatogery1);
