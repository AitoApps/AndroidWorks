...
public class Add_Shops extends AppCompatActivity implements ConnectionCallbacks, OnConnectionFailedListener, LocationListener, OnTimeSetListener {
    ...
    EditText toamt;
    Button tuesday;
    TextView txtdeli, txtdeliinkm, txtfacebook, txtinstagram, txtlattiude, txtlongtitude, txtlytclosing, txtminimcharge, txtminimumcharge, txtmobile1, txtmobile2, txtownername, txtphoto1, txtpinterest, txtplace, txtshopname, txtsocialinfo, txtwebsite, txtyoutube;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.activity_add__shops);
        ...
        location1.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(Add_Shops.this, "android.permission.ACCESS_FINE_LOCATION") != 0) {
                    ActivityCompat.requestPermissions(Add_Shops.this, new String[]{"android.permission.ACCESS_FINE_LOCATION"}, 1);
        ...
        if (Temp.isshopedit == 1) {
            ...
            website.setText(Temp.edit_website);
            instagram.setText(Temp.edit_instagram);
            facebook.setText(Temp.edit_facebook);
            pinterest.setText(Temp.edit_pinterest);
            youtube.setText(Temp.edit_youtube);
        ...
        EasyImage.handleActivityResult(requestCode, resultCode, data2, this, new DefaultCallback() {
            ...
            public void onImagePicked(File imageFile, ImageSource source, int type) {
                ...
                try {
                    ...
                    UCrop.of(Uri.fromFile(imageFile), uri).withOptions(options).withAspectRatio(4.0f, 2.0f).start(Add_Shops.this);
                } catch (Exception e2) {
                }
            }
        });
    ...
    public void uploadfiletoserver() {
        ...
        bodyBuilder.addFormDataPart("website", null, RequestBody.create(contentType, website.getText().toString()));
        bodyBuilder.addFormDataPart("instagram", null, RequestBody.create(contentType, instagram.getText().toString()));
        bodyBuilder.addFormDataPart("facebook", null, RequestBody.create(contentType, facebook.getText().toString()));
        bodyBuilder.addFormDataPart("pinterest", null, RequestBody.create(contentType, pinterest.getText().toString()));
        bodyBuilder.addFormDataPart("youtube", null, RequestBody.create(contentType, youtube.getText().toString()));
