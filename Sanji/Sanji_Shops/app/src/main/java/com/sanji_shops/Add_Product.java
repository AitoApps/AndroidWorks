...
public class Add_Product extends AppCompatActivity {
    ...
    public class UploadFileToServer extends AsyncTask<String, Integer, String> {
        ...
        private String uploadFile() {
            ...
            sb.append("addproductbyshops.php");
            ...
            try {
                ...
                entity.addPart("shopid", new StringBody(Add_Product.udb.get_shopid(), contentType));
                ...
                entity.addPart("trust", new StringBody(Add_Product.udb.get_trusted(), contentType));
        ...
        public void onPostExecute(String result) {
            ...
            if (result.contains("ok")) {
                ...
                if (p[1] == "0") {
                    Toasty.info(Add_Product.getApplicationContext(), "വളരെ നന്ദി !! വെരിഫിക്കേഷന്‍ കഴിഞ്ഞതിന് ശേഷം പ്രൊഡക്ട് ലിസ്റ്റ് ചെയ്യുന്നതായിരിക്കും ", Toast.LENGTH_SHORT).show();
                }
                Add_Product.finish();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> dataAdapter2 = new ArrayAdapter<String>(this, 17367048, Temp.lst_unittype) {
            public View getView(int position, View convertView, ViewGroup parent) {
                View v = super.getView(position, convertView, parent);
                ((TextView) v).setTextColor(ViewCompat.MEASURED_STATE_MASK);
                ((TextView) v).setTextSize(16.0f);
        ...
        if (Temp.isproductedit == 1 || Temp.isproductedit == 2) {
            ...
            if (Temp.isproductedit == 2) {
                foldername = "productpics_admin";
            } else {
                foldername = "productpics";
            }
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                public void run() {
                    ...
                    StringBuilder sb = new StringBuilder();
                    sb.append(Temp.weblink);
                    sb.append(Add_Product.foldername);
                    sb.append("/");
