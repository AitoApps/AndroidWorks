...
import com.sanji_shop.Product_Management;
...
public class Productlist_ListAdapter extends BaseAdapter {
        ...
        public void onPostExecute(String result) {
            if (Productlist_ListAdapter.pd != null || Productlist_ListAdapter.pd.isShowing()) {
                ...
                if (result.contains("ok")) {
                    ...
                    ((Product_Management) Productlist_ListAdapter.activity).removeitem(Productlist_ListAdapter.pos);
                    return;
                }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        StringBuilder sb3 = new StringBuilder();
        TextView textView9 = status;
        sb3.append(Temp.weblink);
        sb3.append("productpicsmall/");
        sb3.append(item.getsn());
        sb3.append("_1.jpg");
        RequestBuilder transition = with.load(sb3.toString()).apply(rep).transition(DrawableTransitionOptions.withCrossFade());
        ImageView image2 = image;
        transition.into(image2);
    ...
    public void updateList(List<Productlist_FeedItem> list) {
        feedItems = list;
