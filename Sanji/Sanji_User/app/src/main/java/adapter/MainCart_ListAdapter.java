...
public class MainCart_ListAdapter extends BaseAdapter {
    ...
    public MainCart_ListAdapter(Activity activity2, List<MainCart_FeedItem> feedItems2) {
        activity = activity2;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        list.setAdapter(new Cart_ListAdapter(activity, cartFeedItems));
                        cartFeedItems.clear();
