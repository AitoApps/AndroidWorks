...
public class GifHeaderParser {
    ...
    public GifHeaderParser setData(@NonNull ByteBuffer data2) {
        reset();
        this.rawData = data2.asReadOnlyBuffer();
        this.rawData.position(0);
        this.rawData.order(ByteOrder.LITTLE_ENDIAN);
        return this;
    }

    public GifHeaderParser setData(@Nullable byte[] data2) {
        if (data2 != null) {
            setData(ByteBuffer.wrap(data2));
        } else {
            this.rawData = null;
