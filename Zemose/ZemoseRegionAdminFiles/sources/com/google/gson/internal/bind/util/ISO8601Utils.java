...
public class ISO8601Utils {
    ...
    public static Date parse(String date, ParsePosition pos) throws ParseException {
        ...
        try {
            ...
            int year = parseInt(str2, offset4, offset5);
            if (checkOffset(str2, offset5, '-')) {
                offset5++;
            }
            int offset6 = offset5 + 2;
            int month = parseInt(str2, offset5, offset6);
            if (checkOffset(str2, offset6, '-')) {
                offset6++;
            }
            int offset7 = offset6 + 2;
            int offset8 = parseInt(str2, offset6, offset7);
            int hour = 0;
            int minutes = 0;
            int seconds = 0;
            int milliseconds = 0;
            boolean hasT = checkOffset(str2, offset7, 'T');
            if (!hasT) {
                try {
                    if (date.length() <= offset7) {
                        Calendar calendar = new GregorianCalendar(year, month - 1, offset8);
            ...
            if (hasT) {
                int offset9 = offset7 + 1;
                int offset10 = offset9 + 2;
                hour = parseInt(str2, offset9, offset10);
                if (checkOffset(str2, offset10, ':')) {
                    offset10++;
                }
                int offset11 = offset10 + 2;
                minutes = parseInt(str2, offset10, offset11);
                if (checkOffset(str2, offset11, ':')) {
                    offset3 = offset11 + 1;
                } else {
                    offset3 = offset11;
                }
                if (date.length() > offset3) {
                    ...
                    if (!(c == 'Z' || c == '+' || c == '-')) {
                        offset = offset3 + 2;
                        int offset12 = parseInt(str2, offset3, offset);
                        if (offset12 <= 59 || offset12 >= 63) {
                            seconds = offset12;
                        } else {
                            seconds = 59;
                        }
                        if (checkOffset(str2, offset, '.')) {
                            int offset13 = offset + 1;
                            int endOffset = indexOfNonDigit(str2, offset13 + 1);
                            int parseEndOffset = Math.min(endOffset, offset13 + 3);
                            int fraction = parseInt(str2, offset13, parseEndOffset);
