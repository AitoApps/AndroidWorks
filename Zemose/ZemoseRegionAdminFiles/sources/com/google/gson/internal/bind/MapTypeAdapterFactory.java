...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        Adapter adapter2 = new Adapter(gson3, keyAndValueTypes[0], typeAdapter, keyAndValueTypes[1], gson2.getAdapter(TypeToken.get(keyAndValueTypes[1])), this.constructorConstructor.get(typeToken));
        return adapter2;
    }
