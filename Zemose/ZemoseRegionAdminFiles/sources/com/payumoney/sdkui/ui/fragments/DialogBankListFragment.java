...
public class DialogBankListFragment extends DialogFragment implements SearchContentChangeListener {
    public static final int REQUEST_CODE_EMI_MORE_BANKS_LIST = 2;
    public static final int REQUEST_CODE_NET_BANKING_LIST = 1;
    ...
    public static DialogBankListFragment newInstance(String transactionType, String addMoneyAmount, boolean isSplitPay, ArrayList<PaymentEntity> netBankingList) {
        return newInstance(transactionType, addMoneyAmount, isSplitPay, netBankingList, 1);
    }

    public static DialogBankListFragment newInstance(String transactionType, String addMoneyAmount, boolean isSplitPay, ArrayList<PaymentEntity> bankList, int requestCode) {
        ...
        bundle.putInt(PPConstants.ARG_BANK_LIST_TYPE, requestCode);
        bundle.putParcelableArrayList(PPConstants.ARG_NET_BANKING_LIST, bankList);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            this.l = getArguments().getInt(PPConstants.ARG_BANK_LIST_TYPE);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        new Handler(Looper.myLooper()).postDelayed(new Runnable() {
            public void run() {
                DialogBankListFragment.this.g.setIconifiedByDefault(false);
                Utils.showKeyBoard(DialogBankListFragment.this.getActivity());
            }
        }, 300);
        return inflate;
    }
    ...
    private void a() {
        ...
        this.i.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                Utils.hideKeyBoard(DialogBankListFragment.this.getActivity(), DialogBankListFragment.this.g.getWindowToken());
                new Handler(Looper.myLooper()).postDelayed(new Runnable() {
                    public void run() {
        ...
        this.g.setOnQueryTextListener(new OnQueryTextListener() {
            public boolean onQueryTextSubmit(String query) {
                try {
                    if (DialogBankListFragment.this.h != null) {
                        DialogBankListFragment.this.h.getFilter().filter(query);
                    }
            ...
            public boolean onQueryTextChange(String newText) {
                if (TextUtils.isEmpty(newText)) {
                    DialogBankListFragment.this.g.post(new Runnable() {
                        public void run() {
                            DialogBankListFragment.this.g.clearFocus();
                        }
                    });
                }
                try {
                    if (DialogBankListFragment.this.h != null) {
                        DialogBankListFragment.this.h.getFilter().filter(newText);
                    }
                } catch (NullPointerException e) {
                    PPLogger.getInstance().e("NullPointerException", (Exception) e);
                }
    ...
    private void b() {
        switch (this.l) {
            case 1:
                this.h = new RecyclerViewAdapter(this.d, this.c, this, PayUmoneyConstants.NET_BANKING_LIST_DIALOG);
                break;
            case 2:
                this.h = new RecyclerViewAdapter(this.d, this.c, this, PayUmoneyConstants.EMI_BANKING_LIST_DIALOG);
                break;
        }
        ...
        try {
            ...
            getDialog().setOnKeyListener(new OnKeyListener() {
                public boolean onKey(DialogInterface dialog, int keyCode, KeyEvent event) {
                    ...
                    hashMap.put(AnalyticsConstant.PAGE, AnalyticsConstant.MORE_NET_BANK);
                    LogAnalytics.logEvent(DialogBankListFragment.this.getContext(), AnalyticsConstant.BACK_BUTTON_CLICKED, hashMap, AnalyticsConstant.CLEVERTAP);
                    DialogBankListFragment.this.dismiss();
                    return true;
                }
            });
    ...
    private void c() {
        this.k = new RecyclerViewOnItemClickListener(getActivity(), new OnItemClickListener() {
            public void onItemClick(View view, int position) {
                Utils.hideKeyBoard(DialogBankListFragment.this.getActivity(), DialogBankListFragment.this.g.getWindowToken());
                PaymentEntity netBankingOption = ((RecyclerViewAdapter) DialogBankListFragment.this.a.getAdapter()).getNetBankingOption(position);
                if (DialogBankListFragment.this.d != null) {
                    if (DialogBankListFragment.this.l == 1) {
                        DialogBankListFragment.this.d.onItemClickListener(netBankingOption, PayUmoneyConstants.NET_BANKING_LIST_DIALOG);
                    } else {
                        DialogBankListFragment.this.d.onItemClickListener(netBankingOption, PayUmoneyConstants.EMI_BANKING_LIST_DIALOG);
                    }
                }
                DialogBankListFragment.this.d = null;
                DialogBankListFragment.this.a.removeOnItemTouchListener(DialogBankListFragment.this.k);
                DialogBankListFragment.this.dismiss();
            }
        });
