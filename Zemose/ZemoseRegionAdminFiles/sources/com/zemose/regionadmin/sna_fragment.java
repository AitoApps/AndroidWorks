...
public class sna_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            this.listAdapter = new Sna_ListAdapter(getActivity(), this.feedItems);
    ...
    public void getpending_Payments() {
        try {
            ...
            sb.append("appadmin/getsna_report_regionhead");
            client.newCall(builder.url(sb.toString()).post(body).build()).enqueue(new Callback() {
                public void onFailure(Call call, IOException e) {
                    sna_fragment.this.getActivity().runOnUiThread(new Runnable() {
                        public void run() {
                            sna_fragment.this.nodata.setVisibility(0);
                            sna_fragment.this.loading.setVisibility(8);
                            sna_fragment.this.recylerview.setVisibility(8);
                        }
                    });
                }
                        ...
                        public void run() {
                            try {
                                ...
                                if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("No")) {
                                    ...
                                    sna_fragment.this.loading.setVisibility(8);
                                    sna_fragment.this.recylerview.setVisibility(8);
                                    Toasty.info(sna_fragment.this.context, "Please contact admin", 0).show();
                                    ...
                                    if (jsonarray.length() > 0) {
                                        ...
                                        sna_fragment.this.loading.setVisibility(8);
                                        sna_fragment.this.recylerview.setVisibility(0);
                                    ...
                                    sna_fragment.this.loading.setVisibility(8);
                                    sna_fragment.this.recylerview.setVisibility(8);
                                    Toasty.info(sna_fragment.this.context, "Please try later", 0).show();
                                }
                            } catch (Exception e) {
                                sna_fragment.this.nodata.setVisibility(0);
                                sna_fragment.this.loading.setVisibility(8);
