            ...
            client.newCall(builder.url(sb.toString()).post(body).build()).enqueue(new Callback() {
                public void onFailure(Call call, IOException e) {
                    Customers_List.this.runOnUiThread(new Runnable() {
                        public void run() {
                            Customers_List.this.nodata.setVisibility(0);
                            Customers_List.this.loading.setVisibility(8);
                            Customers_List.this.recylerview.setVisibility(8);
                        }
                    });
                }
                        ...
                        public void run() {
                            try {
                                ...
                                if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("No")) {
                                    ...
                                    Customers_List.this.loading.setVisibility(8);
                                    Customers_List.this.recylerview.setVisibility(8);
                                    Toasty.info(Customers_List.this.getApplicationContext(), "Please contact admin", 0).show();
                                    ...
                                    Customers_List.this.loading.setVisibility(8);
                                    Customers_List.this.recylerview.setVisibility(0);
                                    Customers_List.this.listAdapter.notifyDataSetChanged();
                                } else {
                                    Customers_List.this.nodata.setVisibility(0);
                                    Customers_List.this.loading.setVisibility(8);
                                    Customers_List.this.recylerview.setVisibility(8);
                                    Toasty.info(Customers_List.this.getApplicationContext(), "Please try later", 0).show();
                                }
                            } catch (Exception e) {
                                Customers_List.this.nodata.setVisibility(0);
                                Customers_List.this.loading.setVisibility(8);
