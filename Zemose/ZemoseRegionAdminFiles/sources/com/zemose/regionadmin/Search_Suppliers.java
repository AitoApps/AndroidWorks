...
public class Search_Suppliers extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.get.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                Toasty.info(Search_Suppliers.this.getApplicationContext(), Temp_Variable.nointernet, 0).show();
            }
        });
    }
    ...
    public void get_supplierlist(String mobile) {
        try {
            ...
            sb.append("appadmin/getsupplier_dtl_by_ID_regionhead");
                ...
                public void onFailure(Call call, IOException e) {
                    Search_Suppliers.this.runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            Toasty.info(Search_Suppliers.this.getApplicationContext(), "Please try later", 0).show();
                        }
                    });
                }
                        ...
                        public void run() {
                            try {
                                ...
                                if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("No")) {
                                    Toasty.info(Search_Suppliers.this.getApplicationContext(), "Not Found", 0).show();
