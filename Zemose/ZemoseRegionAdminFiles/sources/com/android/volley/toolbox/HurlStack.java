    ...
    public HttpResponse executeRequest(Request<?> request, Map<String, String> additionalHeaders) throws IOException, AuthFailureError {
        ...
        try {
            ...
            if (responseCode == -1) {
                ...
                HttpResponse httpResponse = new HttpResponse(responseCode, convertHeaders(connection.getHeaderFields()));
                if (0 == 0) {
                ...
                HttpResponse httpResponse2 = new HttpResponse(responseCode, convertHeaders(connection.getHeaderFields()), connection.getContentLength(), new UrlConnectionInputStream(connection));
                if (1 == 0) {
                    connection.disconnect();
                }
