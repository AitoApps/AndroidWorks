...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    NavigationMenuAdapter f0adapter;
    ...
    final OnClickListener onClickListener = new OnClickListener() {
        public void onClick(View v) {
            ...
            if (item != null && item.isCheckable() && result) {
                NavigationMenuPresenter.this.f0adapter.setCheckedItem(item);
            }
    ...
    public MenuView getMenuView(ViewGroup root) {
        if (this.menuView == null) {
            ...
            if (this.f0adapter == null) {
                this.f0adapter = new NavigationMenuAdapter();
            }
            this.headerLayout = (LinearLayout) this.layoutInflater.inflate(R.layout.design_navigation_item_header, this.menuView, false);
            this.menuView.setAdapter(this.f0adapter);
        }
        return this.menuView;
    }

    public void updateMenuView(boolean cleared) {
        NavigationMenuAdapter navigationMenuAdapter = this.f0adapter;
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        if (parcelable instanceof Bundle) {
            ...
            if (adapterState != null) {
                this.f0adapter.restoreInstanceState(adapterState);
            }
    ...
    public void setCheckedItem(@NonNull MenuItemImpl item) {
        this.f0adapter.setCheckedItem(item);
    }

    @Nullable
    public MenuItemImpl getCheckedItem() {
        return this.f0adapter.getCheckedItem();
    }
