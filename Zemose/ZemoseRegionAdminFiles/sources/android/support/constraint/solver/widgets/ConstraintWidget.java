...
public class ConstraintWidget {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:127:0x028a A[RETURN] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:149:0x02ed  */
    /* JADX WARNING: Removed duplicated region for block: B:153:0x02f9  */
    /* JADX WARNING: Removed duplicated region for block: B:154:0x0302  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:161:0x034e  */
    /* JADX WARNING: Removed duplicated region for block: B:167:0x037c  */
    ...
    public void addToSolver(LinearSystem system) {
        ...
        if (f <= 0.0f || this.mVisibility == 8) {
            ...
            if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT && matchConstraintDefaultWidth2 == 3 && matchConstraintDefaultHeight2 == 3) {
                ...
                boolean verticalDimensionFixed2 = this.mListDimensionBehaviors[0] != DimensionBehaviour.WRAP_CONTENT && (this instanceof ConstraintWidgetContainer);
                ...
                if (useRatio) {
                    ...
                    boolean verticalDimensionFixed22 = this.mListDimensionBehaviors[0] != DimensionBehaviour.WRAP_CONTENT && (this instanceof ConstraintWidgetContainer);
                    if (!this.mCenter.isConnected()) {
                        applyPosition = false;
                    } else {
                        applyPosition = true;
                    ...
                    if (this.mHorizontalResolution == 2) {
                        ...
                        top = top3;
                        right = right3;
                        applyConstraints(system, horizontalParentWrapContent, constraintWidget4 != null ? linearSystem2.createObjectVariable(constraintWidget4.mLeft) : null, parentMax, this.mListDimensionBehaviors[0], verticalDimensionFixed22, this.mLeft, this.mRight, this.mX, width, this.mMinWidth, this.mMaxDimension[0], this.mHorizontalBiasPercent, useHorizontalRatio, inHorizontalChain, matchConstraintDefaultWidth, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth, this.mMatchConstraintPercentWidth, applyPosition);
                    } else {
                        top = top3;
                    ...
                    if (this.mVerticalResolution == 2) {
                        boolean wrapContent = this.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT && (this instanceof ConstraintWidgetContainer);
                        if (useRatio) {
                            ...
                            if (i2 == 1 || i2 == -1) {
                                ...
                                applyConstraints(system, verticalParentWrapContent2, constraintWidget62 != null ? linearSystem.createObjectVariable(constraintWidget62.mTop) : null, parentMax2, this.mListDimensionBehaviors[1], wrapContent, this.mTop, this.mBottom, this.mY, height, this.mMinHeight, this.mMaxDimension[1], this.mVerticalBiasPercent, useVerticalRatio, inVerticalChain, matchConstraintDefaultHeight, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight, this.mMatchConstraintPercentHeight, applyPosition2);
                                if (useRatio) {
                                }
                                if (this.mCenter.isConnected()) {
                                }
                        ...
                        applyConstraints(system, verticalParentWrapContent2, constraintWidget622 != null ? linearSystem.createObjectVariable(constraintWidget622.mTop) : null, parentMax2, this.mListDimensionBehaviors[1], wrapContent, this.mTop, this.mBottom, this.mY, height, this.mMinHeight, this.mMaxDimension[1], this.mVerticalBiasPercent, useVerticalRatio, inVerticalChain, matchConstraintDefaultHeight, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight, this.mMatchConstraintPercentHeight, applyPosition2);
                        if (useRatio) {
                        }
                        if (this.mCenter.isConnected()) {
                        }
                ...
                boolean verticalDimensionFixed222 = this.mListDimensionBehaviors[0] != DimensionBehaviour.WRAP_CONTENT && (this instanceof ConstraintWidgetContainer);
                if (!this.mCenter.isConnected()) {
                }
                if (this.mHorizontalResolution == 2) {
                }
        ...
        boolean verticalDimensionFixed2222 = this.mListDimensionBehaviors[0] != DimensionBehaviour.WRAP_CONTENT && (this instanceof ConstraintWidgetContainer);
        if (!this.mCenter.isConnected()) {
        }
        if (this.mHorizontalResolution == 2) {
        }
    ...
    private void applyConstraints(LinearSystem system, boolean parentWrapContent, SolverVariable parentMin, SolverVariable parentMax, DimensionBehaviour dimensionBehaviour, boolean wrapContent, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int dimension, int minDimension, int maxDimension, float bias, boolean useRatio, boolean inChain, int matchConstraintDefault, int matchMinDimension, int matchMaxDimension, float matchPercentDimension, boolean applyPosition) {
        ...
        if (!variableSize2) {
            if (wrapContent) {
                ...
                if (i8 > 0) {
                    i7 = 6;
                    linearSystem.addGreaterThan(end2, begin5, i8, 6);
                } else {
                    i7 = 6;
                }
                if (i9 < Integer.MAX_VALUE) {
                    linearSystem.addLowerThan(end2, begin5, i9, i7);
                }
            } else {
            ...
            numConnections2 = matchMaxDimension;
        } else {
            ...
            if (matchMinDimension4 > 0) {
                i5 = 6;
                linearSystem.addGreaterThan(end2, begin5, matchMinDimension4, 6);
                dimension2 = Math.max(dimension2, matchMinDimension4);
            } else {
                i5 = 6;
            }
            if (matchMaxDimension3 > 0) {
                linearSystem.addLowerThan(end2, begin5, matchMaxDimension3, i5);
            ...
            if (!variableSize2 || numConnections3 == i6 || useRatio) {
                numConnections2 = matchMaxDimension2;
                matchMinDimension2 = matchMinDimension3;
            } else {
                variableSize2 = false;
                int matchMinDimension5 = matchMinDimension3;
                int d = Math.max(matchMinDimension5, dimension3);
                ...
                numConnections2 = matchMaxDimension4;
        ...
        if (!applyPosition) {
            ...
            begin = begin5;
            matchConstraintDefault4 = numConnections3;
            SolverVariable solverVariable4 = endTarget;
            begin2 = end2;
        } else if (inChain) {
            int i12 = dimension3;
            int i13 = matchConstraintDefault3;
            ...
            if (isBeginConnected || isEndConnected || isCenterConnected) {
                if (!isBeginConnected || isEndConnected) {
                    if (isBeginConnected || !isEndConnected) {
                        ...
                        if (!isBeginConnected || !isEndConnected) {
                            ...
                            if (variableSize2) {
                                if (parentWrapContent && i8 == 0) {
                                    linearSystem.addGreaterThan(end2, begin5, 0, 6);
                                }
                                if (matchConstraintDefault3 == 0) {
                                    int strength = 6;
                                    if (numConnections2 > 0 || matchMinDimension2 > 0) {
                                        strength = 4;
                                    ...
                                    if (matchConstraintDefault3 == 1) {
                                        ...
                                        if (!useRatio) {
                                            int i17 = dimension3;
                                            matchConstraintDefault5 = matchConstraintDefault3;
                                            if (this.mResolvedDimensionRatioSide != -1 && numConnections2 <= 0) {
                                                strength2 = 6;
                                            }
                                        } else {
                                            matchConstraintDefault5 = matchConstraintDefault3;
                            ...
                            if (applyCentering) {
                                ...
                                int i19 = numConnections3;
                                system.addCentering(begin5, beginTarget2, beginAnchor.getMargin(), bias, endTarget5, end2, endAnchor.getMargin(), centeringStrength);
                                i4 = 0;
                                boolean isBeginAnchorBarrier = beginAnchor.mTarget.mOwner instanceof Barrier;
                                int i20 = matchConstraintDefault5;
                            ...
                            if (parentWrapContent) {
                                i3 = 6;
                                linearSystem.addGreaterThan(begin4, solverVariable, i4, 6);
                            } else {
                                i3 = 6;
                            }
                        }
                        ...
                        linearSystem.addEquality(end2, endTarget6, -endAnchor.getMargin(), 6);
                        if (parentWrapContent) {
                            ...
                            int matchConstraintDefault7 = numConnections3;
                            ...
                            int matchConstraintDefault8 = numConnections3;
                    ...
                    int i26 = dimension3;
                    int i27 = matchConstraintDefault3;
                    ...
                    int matchConstraintDefault9 = numConnections3;
                    ...
                    int matchConstraintDefault10 = numConnections3;
                ...
                int matchConstraintDefault11 = numConnections3;
                SolverVariable solverVariable25 = endTarget;
                begin3 = end2;
                i3 = 6;
            } else {
                int i32 = dimension3;
                int i33 = matchConstraintDefault3;
                ...
                int matchConstraintDefault12 = numConnections3;
                SolverVariable solverVariable28 = endTarget;
                begin3 = end2;
                i3 = 6;
            }
            if (parentWrapContent) {
                linearSystem.addGreaterThan(solverVariable2, begin3, i4, i3);
            }
            return;
        }
        if (matchConstraintDefault4 < i && parentWrapContent) {
            linearSystem.addGreaterThan(begin, solverVariable, i2, 6);
            linearSystem.addGreaterThan(solverVariable2, begin2, i2, 6);
        }
    }
