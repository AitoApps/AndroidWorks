...
public class AsyncListDiffer<T> {
    ...
    public AsyncListDiffer(@NonNull Adapter adapter2, @NonNull ItemCallback<T> diffCallback) {
        this((ListUpdateCallback) new AdapterListUpdateCallback(adapter2), new Builder(diffCallback).build());
    }
