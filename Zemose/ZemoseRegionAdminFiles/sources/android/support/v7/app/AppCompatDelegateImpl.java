...
class AppCompatDelegateImpl extends AppCompatDelegate implements Callback, Factory2 {
    ...
    class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        @RequiresApi(24)
        public void onProvideKeyboardShortcuts(List<KeyboardShortcutGroup> data2, Menu menu, int deviceId) {
            PanelFeatureState panel = AppCompatDelegateImpl.this.getPanelState(0, true);
            if (panel == null || panel.menu == null) {
                super.onProvideKeyboardShortcuts(data2, menu, deviceId);
            } else {
                super.onProvideKeyboardShortcuts(data2, panel.menu, deviceId);
            }
        }
    }
