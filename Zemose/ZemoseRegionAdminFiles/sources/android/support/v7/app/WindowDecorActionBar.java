...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        sb.append(view != null ? view.getClass().getSimpleName() : PayUmoneyConstants.NULL_STRING);
        throw new IllegalStateException(sb.toString());
    }
    ...
    public void setListNavigationCallbacks(SpinnerAdapter adapter2, OnNavigationListener callback) {
        this.mDecorToolbar.setDropdownParams(adapter2, new NavItemSelectedListener(callback));
    }
