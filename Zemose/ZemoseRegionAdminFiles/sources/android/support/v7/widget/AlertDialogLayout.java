    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        while (i3 < count) {
            ...
            if (child == null || child.getVisibility() == 8) {
                ...
                int childLeft = absoluteGravity != 1 ? absoluteGravity != 5 ? lp.leftMargin + paddingLeft : (childRight - childWidth) - lp.rightMargin : ((((childSpace - childWidth) / 2) + paddingLeft) + lp.leftMargin) - lp.rightMargin;
