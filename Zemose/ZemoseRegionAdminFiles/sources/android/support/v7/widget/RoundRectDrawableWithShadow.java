...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    private void buildShadowCorners() {
        ...
        RadialGradient radialGradient2 = new RadialGradient(0.0f, 0.0f, f5, new int[]{i, i, this.mShadowEndColor}, new float[]{0.0f, startRatio, 1.0f}, TileMode.CLAMP);
        ...
        LinearGradient linearGradient = new LinearGradient(0.0f, f9, 0.0f, f10, new int[]{i2, i2, this.mShadowEndColor}, new float[]{0.0f, 0.5f, 1.0f}, TileMode.CLAMP);
