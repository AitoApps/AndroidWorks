...
public class ViewDragHelper {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0076, code lost:
        if (r0.canScrollVertically(-r19) != false) goto L_0x0081;
     */
        ...
        switch (action2) {
            ...
            case 5:
                ...
                if (i12 != 0) {
                    ...
                    if ((edgesTouched2 & i15) != 0) {
                        this.mCallback.onEdgeTouched(i15 & edgesTouched2, pointerId3);
                    }
                }
                int i16 = action2;
