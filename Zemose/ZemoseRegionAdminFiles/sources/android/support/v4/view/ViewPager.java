...
public class ViewPager extends ViewGroup {
    ...
    public void setAdapter(@Nullable PagerAdapter adapter2) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            for (int i2 = 0; i2 < count; i2++) {
                ((OnAdapterChangeListener) this.mAdapterChangeListeners.get(i2)).onAdapterChanged(this, oldAdapter, adapter2);
            }
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:7:0x0015, code lost:
        if (r3.getCount() > 1) goto L_0x0027;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x006a, code lost:
        if (r15.canScrollHorizontally(-r17) != false) goto L_0x0070;
     */
