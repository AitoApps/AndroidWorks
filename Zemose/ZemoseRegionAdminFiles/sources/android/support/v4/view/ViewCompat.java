...
public class ViewCompat {
    ...
    public static boolean startDragAndDrop(@NonNull View v, ClipData data2, DragShadowBuilder shadowBuilder, Object localState, int flags) {
        if (VERSION.SDK_INT >= 24) {
            return v.startDragAndDrop(data2, shadowBuilder, localState, flags);
        }
        return v.startDrag(data2, shadowBuilder, localState, flags);
    }
