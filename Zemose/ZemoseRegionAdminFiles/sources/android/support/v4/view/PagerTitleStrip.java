...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void onAttachedToWindow() {
        ...
        if (parent instanceof ViewPager) {
            ...
            updateAdapter(weakReference != null ? (PagerAdapter) weakReference.get() : null, adapter2);
            return;
        }
    ...
    public void updateText(int currentItem, PagerAdapter adapter2) {
        int itemCount = adapter2 != null ? adapter2.getCount() : 0;
        this.mUpdatingText = true;
        CharSequence text = null;
        if (currentItem >= 1 && adapter2 != null) {
            text = adapter2.getPageTitle(currentItem - 1);
        }
        this.mPrevText.setText(text);
        this.mCurrText.setText((adapter2 == null || currentItem >= itemCount) ? null : adapter2.getPageTitle(currentItem));
        CharSequence text2 = null;
        if (currentItem + 1 < itemCount && adapter2 != null) {
            text2 = adapter2.getPageTitle(currentItem + 1);
        }
