            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        String _arg07 = data2.readString();
                        if (data2.readInt() != 0) {
                    ...
                    case 3:
                        data2.enforceInterface(DESCRIPTOR);
                        if (data2.readInt() != 0) {
                            _arg0 = (PlaybackStateCompat) PlaybackStateCompat.CREATOR.createFromParcel(data2);
                        } else {
                            _arg0 = null;
                        }
                    ...
                    case 4:
                        data2.enforceInterface(DESCRIPTOR);
                        if (data2.readInt() != 0) {
                            _arg02 = (MediaMetadataCompat) MediaMetadataCompat.CREATOR.createFromParcel(data2);
                        } else {
                            _arg02 = null;
                        }
                    ...
                    case 5:
                        data2.enforceInterface(DESCRIPTOR);
                        onQueueChanged(data2.createTypedArrayList(QueueItem.CREATOR));
                        return true;
                    case 6:
                        data2.enforceInterface(DESCRIPTOR);
                        if (data2.readInt() != 0) {
                            _arg03 = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(data2);
                        } else {
                            _arg03 = null;
                        }
                    ...
                    case 7:
                        data2.enforceInterface(DESCRIPTOR);
                        if (data2.readInt() != 0) {
                            _arg04 = (Bundle) Bundle.CREATOR.createFromParcel(data2);
                        } else {
                            _arg04 = null;
                        }
                    ...
                    case 8:
                        data2.enforceInterface(DESCRIPTOR);
                        if (data2.readInt() != 0) {
                            _arg05 = (ParcelableVolumeInfo) ParcelableVolumeInfo.CREATOR.createFromParcel(data2);
                        } else {
                            _arg05 = null;
                        }
                    ...
                    case 9:
                        data2.enforceInterface(DESCRIPTOR);
                        onRepeatModeChanged(data2.readInt());
                        return true;
                    case 10:
                        data2.enforceInterface(DESCRIPTOR);
                        if (data2.readInt() != 0) {
                    ...
                    case 12:
                        data2.enforceInterface(DESCRIPTOR);
                        onShuffleModeChanged(data2.readInt());
                        return true;
                    default:
