...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements DeathRecipient {
        ...
        /* access modifiers changed from: 0000 */
        public void postToHandler(int what, Object obj, Bundle data2) {
            MessageHandler messageHandler = this.mHandler;
            if (messageHandler != null) {
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public PlaybackInfo getPlaybackInfo() {
            ...
            PlaybackInfo playbackInfo = new PlaybackInfo(android.support.v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getPlaybackType(volumeInfoObj), android.support.v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getLegacyAudioStream(volumeInfoObj), android.support.v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getVolumeControl(volumeInfoObj), android.support.v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getMaxVolume(volumeInfoObj), android.support.v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getCurrentVolume(volumeInfoObj));
            return playbackInfo;
        }
