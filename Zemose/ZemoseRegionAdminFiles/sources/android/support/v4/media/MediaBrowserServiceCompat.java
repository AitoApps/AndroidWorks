...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    private class ServiceBinderImpl {
        ...
        public void disconnect(final ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    Object remove = MediaBrowserServiceCompat.this.mConnections.remove(callbacks.asBinder());
                }
            });
        }
    ...
    private static class ServiceCallbacksCompat implements ServiceCallbacks {
        ...
        public void onConnect(String root, Token session, Bundle extras) throws RemoteException {
            ...
            data2.putString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID, root);
            data2.putParcelable(MediaBrowserProtocol.DATA_MEDIA_SESSION_TOKEN, session);
            data2.putBundle(MediaBrowserProtocol.DATA_ROOT_HINTS, extras);
            sendRequest(1, data2);
        }
        ...
        public void onLoadChildren(String mediaId, List<MediaItem> list, Bundle options) throws RemoteException {
            Bundle data2 = new Bundle();
            data2.putString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID, mediaId);
            data2.putBundle(MediaBrowserProtocol.DATA_OPTIONS, options);
            if (list != null) {
                data2.putParcelableArrayList(MediaBrowserProtocol.DATA_MEDIA_ITEM_LIST, list instanceof ArrayList ? (ArrayList) list : new ArrayList(list));
            }
            sendRequest(3, data2);
        }

        private void sendRequest(int what, Bundle data2) throws RemoteException {
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    this.mServiceBinderImpl.connect(data2.getString(MediaBrowserProtocol.DATA_PACKAGE_NAME), data2.getInt(MediaBrowserProtocol.DATA_CALLING_UID), data2.getBundle(MediaBrowserProtocol.DATA_ROOT_HINTS), new ServiceCallbacksCompat(msg.replyTo));
                    return;
                case 2:
                    this.mServiceBinderImpl.disconnect(new ServiceCallbacksCompat(msg.replyTo));
                    return;
                case 3:
                    this.mServiceBinderImpl.addSubscription(data2.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), BundleCompat.getBinder(data2, MediaBrowserProtocol.DATA_CALLBACK_TOKEN), data2.getBundle(MediaBrowserProtocol.DATA_OPTIONS), new ServiceCallbacksCompat(msg.replyTo));
                    return;
                case 4:
                    this.mServiceBinderImpl.removeSubscription(data2.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), BundleCompat.getBinder(data2, MediaBrowserProtocol.DATA_CALLBACK_TOKEN), new ServiceCallbacksCompat(msg.replyTo));
                    return;
                case 5:
                    this.mServiceBinderImpl.getMediaItem(data2.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), (ResultReceiver) data2.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(msg.replyTo));
                    return;
                case 6:
                    this.mServiceBinderImpl.registerCallbacks(new ServiceCallbacksCompat(msg.replyTo), data2.getBundle(MediaBrowserProtocol.DATA_ROOT_HINTS));
                    return;
                case 7:
                    this.mServiceBinderImpl.unregisterCallbacks(new ServiceCallbacksCompat(msg.replyTo));
                    return;
                case 8:
                    this.mServiceBinderImpl.search(data2.getString(MediaBrowserProtocol.DATA_SEARCH_QUERY), data2.getBundle(MediaBrowserProtocol.DATA_SEARCH_EXTRAS), (ResultReceiver) data2.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(msg.replyTo));
                    return;
                case 9:
                    this.mServiceBinderImpl.sendCustomAction(data2.getString(MediaBrowserProtocol.DATA_CUSTOM_ACTION), data2.getBundle(MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS), (ResultReceiver) data2.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(msg.replyTo));
                    return;
                default:
                    String str = MediaBrowserServiceCompat.TAG;
                    StringBuilder sb = new StringBuilder();
        ...
        public boolean sendMessageAtTime(Message msg, long uptimeMillis) {
            Bundle data2 = msg.getData();
            data2.setClassLoader(MediaBrowserCompat.class.getClassLoader());
    ...
    public void performLoadChildren(String parentId, ConnectionRecord connection, Bundle options) {
        ...
        final Bundle bundle = options;
        AnonymousClass1 r0 = new Result<List<MediaItem>>(parentId) {
            /* access modifiers changed from: 0000 */
            public void onResultSent(List<MediaItem> list) {
    ...
    public void performCustomAction(String action, Bundle extras, ConnectionRecord connection, final ResultReceiver receiver) {
        Result<Bundle> result = new Result<Bundle>(action) {
            ...
            /* access modifiers changed from: 0000 */
            public void onProgressUpdateSent(Bundle data2) {
                receiver.send(1, data2);
            }

            /* access modifiers changed from: 0000 */
            public void onErrorSent(Bundle data2) {
                receiver.send(-1, data2);
            }
        };
        this.mCurConnection = connection;
