...
public final class MediaBrowserCompat {
    ...
    private static class CallbackHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (weakReference != null && weakReference.get() != null && this.mCallbackImplRef.get() != null) {
                ...
                data2.setClassLoader(MediaSessionCompat.class.getClassLoader());
                ...
                try {
                    switch (msg.what) {
                        case 1:
                            serviceCallback.onServiceConnected(callbacksMessenger, data2.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), (Token) data2.getParcelable(MediaBrowserProtocol.DATA_MEDIA_SESSION_TOKEN), data2.getBundle(MediaBrowserProtocol.DATA_ROOT_HINTS));
                            break;
                        case 2:
                            serviceCallback.onConnectionFailed(callbacksMessenger);
                            break;
                        case 3:
                            serviceCallback.onLoadChildren(callbacksMessenger, data2.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), data2.getParcelableArrayList(MediaBrowserProtocol.DATA_MEDIA_ITEM_LIST), data2.getBundle(MediaBrowserProtocol.DATA_OPTIONS));
                            break;
                        default:
    ...
    public static abstract class CustomActionCallback {
        public void onProgressUpdate(String action, Bundle extras, Bundle data2) {
        }

        public void onResult(String action, Bundle extras, Bundle resultData) {
        }

        public void onError(String action, Bundle extras, Bundle data2) {
        }
    }
    ...
    private static class ServiceBinderWrapper {
        ...
        public void connect(Context context, Messenger callbacksMessenger) throws RemoteException {
            ...
            data2.putString(MediaBrowserProtocol.DATA_PACKAGE_NAME, context.getPackageName());
            data2.putBundle(MediaBrowserProtocol.DATA_ROOT_HINTS, this.mRootHints);
            sendRequest(1, data2, callbacksMessenger);
        }
        ...
        public void addSubscription(String parentId, IBinder callbackToken, Bundle options, Messenger callbacksMessenger) throws RemoteException {
            Bundle data2 = new Bundle();
            data2.putString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID, parentId);
            BundleCompat.putBinder(data2, MediaBrowserProtocol.DATA_CALLBACK_TOKEN, callbackToken);
            data2.putBundle(MediaBrowserProtocol.DATA_OPTIONS, options);
            sendRequest(3, data2, callbacksMessenger);
        }
        ...
        public void removeSubscription(String parentId, IBinder callbackToken, Messenger callbacksMessenger) throws RemoteException {
            ...
            data2.putString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID, parentId);
            BundleCompat.putBinder(data2, MediaBrowserProtocol.DATA_CALLBACK_TOKEN, callbackToken);
            sendRequest(4, data2, callbacksMessenger);
        }
        ...
        public void getMediaItem(String mediaId, ResultReceiver receiver, Messenger callbacksMessenger) throws RemoteException {
            ...
            data2.putParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER, receiver);
            sendRequest(5, data2, callbacksMessenger);
        }
        ...
        public void registerCallbackMessenger(Messenger callbackMessenger) throws RemoteException {
            Bundle data2 = new Bundle();
            data2.putBundle(MediaBrowserProtocol.DATA_ROOT_HINTS, this.mRootHints);
            sendRequest(6, data2, callbackMessenger);
        }
        ...
        public void search(String query, Bundle extras, ResultReceiver receiver, Messenger callbacksMessenger) throws RemoteException {
            Bundle data2 = new Bundle();
            data2.putString(MediaBrowserProtocol.DATA_SEARCH_QUERY, query);
            data2.putBundle(MediaBrowserProtocol.DATA_SEARCH_EXTRAS, extras);
            data2.putParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER, receiver);
            sendRequest(8, data2, callbacksMessenger);
        }
        ...
        public void sendCustomAction(String action, Bundle extras, ResultReceiver receiver, Messenger callbacksMessenger) throws RemoteException {
            Bundle data2 = new Bundle();
            data2.putString(MediaBrowserProtocol.DATA_CUSTOM_ACTION, action);
            data2.putBundle(MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS, extras);
            data2.putParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER, receiver);
            sendRequest(9, data2, callbacksMessenger);
        }

        private void sendRequest(int what, Bundle data2, Messenger cbMessenger) throws RemoteException {
