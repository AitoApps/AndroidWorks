...
public abstract class AsyncTaskLoader<D> extends Loader<D> {
    ...
    final class LoadTask extends ModernAsyncTask<Void, Void, D> implements Runnable {
        ...
        /* access modifiers changed from: protected */
        public void onPostExecute(D data2) {
            try {
                AsyncTaskLoader.this.dispatchOnLoadComplete(this, data2);
            } finally {
        ...
        /* access modifiers changed from: protected */
        public void onCancelled(D data2) {
            try {
                AsyncTaskLoader.this.dispatchOnCancelled(this, data2);
            } finally {
                this.mDone.countDown();
            }
        }
    ...
    /* access modifiers changed from: 0000 */
    public void dispatchOnCancelled(LoadTask task, D data2) {
        onCanceled(data2);
    ...
    /* access modifiers changed from: 0000 */
    public void dispatchOnLoadComplete(LoadTask task, D data2) {
        if (this.mTask != task) {
            dispatchOnCancelled(task, data2);
        } else if (isAbandoned()) {
            onCanceled(data2);
        } else {
