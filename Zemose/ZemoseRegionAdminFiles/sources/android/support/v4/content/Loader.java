...
public class Loader<D> {
    ...
    @MainThread
    public void deliverResult(@Nullable D data2) {
        OnLoadCompleteListener<D> onLoadCompleteListener = this.mListener;
        if (onLoadCompleteListener != null) {
            onLoadCompleteListener.onLoadComplete(this, data2);
        }
    }
    ...
    @NonNull
    public String dataToString(@Nullable D data2) {
        StringBuilder sb = new StringBuilder(64);
        DebugUtils.buildShortClassTag(data2, sb);
        sb.append("}");
        return sb.toString();
    }
