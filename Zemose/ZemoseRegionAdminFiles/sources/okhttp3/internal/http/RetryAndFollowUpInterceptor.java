        ...
        while (!this.canceled) {
            ...
            try {
                ...
                if (priorResponse != null) {
                    response = response2.newBuilder().priorResponse(priorResponse.newBuilder().body(null).build()).build();
                } else {
                    response = response2;
                }
                try {
                    ...
                    RealInterceptorChain realInterceptorChain = realChain3;
                    streamAllocation2.release();
                    throw e;
                }
            } catch (RouteException e2) {
                realChain = realChain3;
                RouteException e3 = e2;
                ...
                if (recover(e5, streamAllocation2, z, request2)) {
                    if (0 != 0) {
                        streamAllocation2.streamFailed(null);
                        streamAllocation2.release();
                    }
