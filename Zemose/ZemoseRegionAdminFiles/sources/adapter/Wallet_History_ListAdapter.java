...
public class Wallet_History_ListAdapter extends Adapter<ViewHolder> {
    ...
    public Wallet_History_ListAdapter(Activity activity2, List<Wallet_History_FeedItem> feedItems2) {
