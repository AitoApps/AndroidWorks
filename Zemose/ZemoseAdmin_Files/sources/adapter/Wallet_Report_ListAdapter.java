...
import com.zemose.admin.Wallets_Report;
import data.Wallet_Report_FeedItem;
import java.util.List;

public class Wallet_Report_ListAdapter extends Adapter<ViewHolder> {
    ...
    public Wallet_Report_ListAdapter(Activity activity2, List<Wallet_Report_FeedItem> feedItems2) {
