...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        public View findContainingItemView(@NonNull View view) {
            ...
            View found = recyclerView.findContainingItemView(view);
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:7:0x001d, code lost:
            if (r8 != 1073741824) goto L_0x0047;
         */
        ...
        public void onInitializeAccessibilityNodeInfoForItem(@NonNull Recycler recycler, @NonNull State state, @NonNull View host, @NonNull AccessibilityNodeInfoCompat info) {
            info.setCollectionItemInfo(CollectionItemInfoCompat.obtain(canScrollVertically() ? getPosition(host) : 0, 1, canScrollHorizontally() ? getPosition(host) : 0, 1, false, false));
        }
            ...
            if (holder2 == null) {
                ...
                if (holder2 == null) {
                    ...
                    if (viewCacheExtension != null) {
                        View view = viewCacheExtension.getViewForPositionAndType(this, i, type);
                        if (view != null) {
                ...
                if (holder2 == null) {
                    ...
                    if (RecyclerView.ALLOW_THREAD_GAP_WORK) {
                        RecyclerView innerView = RecyclerView.findNestedRecyclerView(holder3.itemView);
                        if (innerView != null) {
    ...
    public static class State {
        ...
        /* access modifiers changed from: 0000 */
        public void prepareForNestedPrefetch(Adapter adapter2) {
            this.mLayoutStep = 1;
        ...
        public void put(int resourceId, Object data2) {
            if (this.mData == null) {
                this.mData = new SparseArray<>();
            }
            this.mData.put(resourceId, data2);
        }
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    int vresult2 = RecyclerView.this.mScrollStepConsumed[1];
                    int overscrollX2 = dx - hresult;
                    int overscrollY2 = dy - vresult2;
                ...
                if (RecyclerView.this.dispatchNestedScroll(hresult, vresult, overscrollX, overscrollY, null, 1)) {
    ...
    public void swapAdapter(@Nullable Adapter adapter2, boolean removeAndRecycleExistingViews) {
    ...
    private void setAdapterInternal(@Nullable Adapter adapter2, boolean compatibleWithPrevious, boolean removeAndRecycleViews) {
        ...
        if (layout != this.mLayout) {
            ...
            if (layout != null) {
                if (layout.mRecyclerView == null) {
                    ...
                    sb.append(layout.mRecyclerView.exceptionLabel());
                    throw new IllegalArgumentException(sb.toString());
                }
            }
    ...
    public boolean scrollByInternal(int x, int y, MotionEvent ev) {
        ...
        if (this.mAdapter != null) {
            ...
            unconsumedX = i - consumedX2;
            unconsumedY = i2 - consumedY3;
        ...
        dispatchOnScrolled(consumedX, consumedY2);
        if (!awakenScrollBars()) {
            invalidate();
        }
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (!canRunFocusFailure || !(direction == 2 || direction == 1)) {
            ...
            if (this.mLayout.canScrollVertically()) {
                int absDir = direction == 2 ? BuildConfig.VERSION_CODE : 33;
    ...
    public void dispatchChildDetached(View child) {
        ...
        Adapter adapter2 = this.mAdapter;
        if (!(adapter2 == null || viewHolder == null)) {
