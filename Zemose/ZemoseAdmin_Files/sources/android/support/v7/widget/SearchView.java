...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public void setSuggestionsAdapter(CursorAdapter adapter2) {
        this.mSuggestionsAdapter = adapter2;
    ...
    private Intent createIntent(String action, Uri data2, String extraData, String query, int actionKey, String actionMsg) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:17:0x0054 A[Catch:{ RuntimeException -> 0x0070 }] */
    /* JADX WARNING: Removed duplicated region for block: B:18:0x0056 A[Catch:{ RuntimeException -> 0x0070 }] */
    private Intent createIntentFromSuggestion(Cursor c, int actionKey, String actionMsg) {
        ...
        try {
            ...
            String data3 = SuggestionsAdapter.getColumnString(c, "suggest_intent_data");
            if (data3 == null) {
                data3 = this.mSearchable.getSuggestIntentData();
            }
            if (data3 != null) {
