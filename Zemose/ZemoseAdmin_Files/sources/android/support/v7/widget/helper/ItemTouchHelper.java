...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    /* access modifiers changed from: 0000 */
    public void select(@Nullable ViewHolder selected, int actionState) {
        int prevActionState;
        boolean z;
        int i;
        ...
        if (viewHolder != this.mSelected || i2 != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (prevSelected.itemView.getParent() != null) {
                    ...
                    AnonymousClass3 r0 = new RecoverAnimation(this, prevSelected, animationType, prevActionState2, currentTranslateX, currentTranslateY, targetTranslateX, targetTranslateY) {
