...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        public Builder setAdapter(ListAdapter adapter2, OnClickListener listener) {
            AlertParams alertParams = this.P;
            alertParams.mAdapter = adapter2;
            alertParams.mOnClickListener = listener;
            return this;
        }
        ...
        public Builder setSingleChoiceItems(ListAdapter adapter2, int checkedItem, OnClickListener listener) {
            AlertParams alertParams = this.P;
            alertParams.mAdapter = adapter2;
            alertParams.mOnClickListener = listener;
            alertParams.mCheckedItem = checkedItem;
