...
abstract class MenuPopup implements ShowableListMenu, MenuPresenter, OnItemClickListener {
    ...
    protected static int measureIndividualMenuWidth(ListAdapter adapter2, ViewGroup parent, Context context, int maxAllowedWidth) {
        int maxWidth = 0;
        View itemView = null;
        int itemType = 0;
        ...
        for (int i = 0; i < count; i++) {
            ...
            itemView = adapter2.getView(i, itemView, parent);
    ...
    protected static MenuAdapter toMenuAdapter(ListAdapter adapter2) {
        if (adapter2 instanceof HeaderViewListAdapter) {
            return (MenuAdapter) ((HeaderViewListAdapter) adapter2).getWrappedAdapter();
        }
        return (MenuAdapter) adapter2;
    }
