            ...
            if (code != 1598968902) {
                switch (code) {
                    case 1:
                        ...
                        String _arg0 = data2.readString();
                        int _arg1 = data2.readInt();
                        String _arg2 = data2.readString();
                        if (data2.readInt() != 0) {
                            _arg3 = (Notification) Notification.CREATOR.createFromParcel(data2);
                        } else {
                            _arg3 = null;
                        }
                    ...
                    case 2:
                        data2.enforceInterface(DESCRIPTOR);
                        cancel(data2.readString(), data2.readInt(), data2.readString());
                        return true;
                    case 3:
                        data2.enforceInterface(DESCRIPTOR);
                        cancelAll(data2.readString());
                        return true;
                    default:
