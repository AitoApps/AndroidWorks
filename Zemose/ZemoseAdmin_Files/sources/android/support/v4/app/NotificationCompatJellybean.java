...
class NotificationCompatJellybean {
    ...
    private static RemoteInput fromBundle(Bundle data2) {
        ArrayList<String> allowedDataTypesAsList = data2.getStringArrayList(KEY_ALLOWED_DATA_TYPES);
        ...
        RemoteInput remoteInput = new RemoteInput(data2.getString(KEY_RESULT_KEY), data2.getCharSequence(KEY_LABEL), data2.getCharSequenceArray(KEY_CHOICES), data2.getBoolean(KEY_ALLOW_FREE_FORM_INPUT), data2.getBundle(KEY_EXTRAS), hashSet);
        return remoteInput;
    }

    private static Bundle toBundle(RemoteInput remoteInput) {
        Bundle data2 = new Bundle();
        data2.putString(KEY_RESULT_KEY, remoteInput.getResultKey());
        data2.putCharSequence(KEY_LABEL, remoteInput.getLabel());
        data2.putCharSequenceArray(KEY_CHOICES, remoteInput.getChoices());
        data2.putBoolean(KEY_ALLOW_FREE_FORM_INPUT, remoteInput.getAllowFreeFormInput());
        data2.putBundle(KEY_EXTRAS, remoteInput.getExtras());
        ...
        if (allowedDataTypes != null && !allowedDataTypes.isEmpty()) {
            ...
            data2.putStringArrayList(KEY_ALLOWED_DATA_TYPES, allowedDataTypesAsList);
        }
        return data2;
    }
