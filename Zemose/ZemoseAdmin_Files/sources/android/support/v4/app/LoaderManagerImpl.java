...
class LoaderManagerImpl extends LoaderManager {
    ...
    public static class LoaderInfo<D> extends MutableLiveData<D> implements OnLoadCompleteListener<D> {
        ...
        public void onLoadComplete(@NonNull Loader<D> loader, @Nullable D data2) {
            if (LoaderManagerImpl.DEBUG) {
                String str = LoaderManagerImpl.TAG;
                StringBuilder sb = new StringBuilder();
    ...
    static class LoaderObserver<D> implements Observer<D> {
        ...
        public void onChanged(@Nullable D data2) {
            if (LoaderManagerImpl.DEBUG) {
                String str = LoaderManagerImpl.TAG;
                StringBuilder sb = new StringBuilder();
                ...
                sb.append(": ");
                sb.append(this.mLoader.dataToString(data2));
                Log.v(str, sb.toString());
            }
            this.mCallback.onLoadFinished(this.mLoader, data2);
