...
public final class TextViewCompat {
    ...
    private static class OreoCallback implements Callback {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:17:0x0062 A[Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x00bb }] */
        /* JADX WARNING: Removed duplicated region for block: B:26:0x009a A[LOOP:1: B:24:0x0094->B:26:0x009a, LOOP_END] */
            ...
            try {
                if (this.mCanUseMenuBuilderReferences) {
                    if (this.mMenuBuilderClass.isInstance(menu)) {
                        ...
                        for (i2 = 0; i2 < supportedActivities.size(); i2++) {
                ...
                supportedActivities = getSupportedActivities(context, packageManager);
                while (i2 < supportedActivities.size()) {
                }
