...
class FocusStrategy {
    ...
    private static class SequentialComparator<T> implements Comparator<T> {
        ...
        SequentialComparator(boolean isLayoutRtl, BoundsAdapter<T> adapter2) {
    ...
    public static <L, T> T findNextFocusInRelativeDirection(@NonNull L focusables, @NonNull CollectionAdapter<L, T> collectionAdapter, @NonNull BoundsAdapter<T> adapter2, @Nullable T focused, int direction, boolean isLayoutRtl, boolean wrap) {
        ...
        Collections.sort(sortedFocusables, new SequentialComparator<>(isLayoutRtl, adapter2));
        switch (direction) {
            case 1:
    ...
    public static <L, T> T findNextFocusInAbsoluteDirection(@NonNull L focusables, @NonNull CollectionAdapter<L, T> collectionAdapter, @NonNull BoundsAdapter<T> adapter2, @Nullable T focused, @NonNull Rect focusedRect, int direction) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (focusable != focused) {
                adapter2.obtainBounds(focusable, focusableRect);
