...
public final class MimeTypeFilter {
    ...
    private static boolean mimeTypeAgainstFilter(@NonNull String[] mimeTypeParts, @NonNull String[] filterParts) {
        if (filterParts.length != 2) {
            ...
            if (CBConstant.DEFAULT_PAYMENT_URLS.equals(filterParts[0]) || filterParts[0].equals(mimeTypeParts[0])) {
                return CBConstant.DEFAULT_PAYMENT_URLS.equals(filterParts[1]) || filterParts[1].equals(mimeTypeParts[1]);
            }
            return false;
        }
    }
