...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public OutputStream outputStream() {
        return new OutputStream() {
            ...
            public void write(byte[] data2, int offset, int byteCount) {
                Buffer.this.write(data2, offset, byteCount);
            }
    ...
    public Buffer copyTo(OutputStream out, long offset, long byteCount) throws IOException {
        if (out != null) {
            ...
            while (byteCount > 0) {
                ...
                out.write(s.f16data, pos, toCopy);
    ...
    public Buffer writeTo(OutputStream out, long byteCount) throws IOException {
        if (out != null) {
            ...
            while (byteCount > 0) {
                ...
                out.write(s.f16data, s.pos, toCopy);
                s.pos += toCopy;
        ...
        if (in != null) {
            while (true) {
                if (byteCount > 0 || forever) {
                    ...
                    int bytesRead = in.read(tail.f16data, tail.limit, (int) Math.min(byteCount, (long) (8192 - tail.limit)));
                    if (bytesRead != -1) {
        ...
        if (j - pos > pos) {
            ...
            while (true) {
                ...
                if (pos < ((long) segmentByteCount)) {
                    return s.f16data[s.pos + ((int) pos)];
                }
            ...
            while (true) {
                ...
                if (pos2 >= 0) {
                    return s2.f16data[s2.pos + ((int) pos2)];
                }
                s2 = s2.prev;
            }
        }
    ...
    public short readShort() {
        if (this.size >= 2) {
            ...
            byte[] data2 = segment.f16data;
            int pos2 = pos + 1;
            int pos3 = pos2 + 1;
            int s = ((data2[pos] & 255) << 8) | (data2[pos2] & 255);
            this.size -= 2;
            if (pos3 == limit) {
                this.head = segment.pop();
                SegmentPool.recycle(segment);
    ...
    public int readInt() {
        if (this.size >= 4) {
            ...
            int pos2 = pos + 1;
            int pos3 = pos2 + 1;
            int i = ((data2[pos] & 255) << 24) | ((data2[pos2] & 255) << 16);
            int pos4 = pos3 + 1;
            int i2 = i | ((data2[pos3] & 255) << 8);
            int pos5 = pos4 + 1;
            int i3 = i2 | (data2[pos4] & 255);
            this.size -= 4;
            if (pos5 == limit) {
                this.head = segment.pop();
                SegmentPool.recycle(segment);
    ...
    public long readLong() {
        if (this.size >= 8) {
            ...
            int pos8 = pos7 + 1;
            int pos9 = pos8 + 1;
            long v = ((((long) data2[pos]) & 255) << 56) | ((((long) data2[pos2]) & 255) << 48) | ((((long) data2[pos3]) & 255) << 40) | ((((long) data2[pos4]) & 255) << 32) | ((((long) data2[pos5]) & 255) << 24) | ((((long) data2[pos6]) & 255) << 16) | ((((long) data2[pos7]) & 255) << 8) | (((long) data2[pos8]) & 255);
            this.size -= 8;
            if (pos9 == limit) {
                this.head = segment.pop();
                SegmentPool.recycle(segment);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:42:0x007b A[SYNTHETIC] */
    ...
    public String readString(long byteCount, Charset charset) throws EOFException {
        ...
        if (charset == null) {
            ...
            String result = new String(s.f16data, s.pos, (int) byteCount, charset);
    ...
    public String readUtf8LineStrict(long limit) throws EOFException {
        if (limit >= 0) {
            ...
            copyTo(data2, 0, Math.min(32, size()));
            StringBuilder sb = new StringBuilder();
            sb.append("\\n not found: limit=");
            sb.append(Math.min(size(), limit));
            sb.append(" content=");
            sb.append(data2.readByteString().hex());
            sb.append(8230);
    ...
    public int read(byte[] sink, int offset, int byteCount) {
        ...
        System.arraycopy(s.f16data, s.pos, sink, offset, toCopy);
        s.pos += toCopy;
        this.size -= (long) toCopy;
        if (s.pos == s.limit) {
            this.head = s.pop();
    ...
    public int read(ByteBuffer sink) throws IOException {
        ...
        sink.put(s.f16data, s.pos, toCopy);
        s.pos += toCopy;
        this.size -= (long) toCopy;
        if (s.pos == s.limit) {
            this.head = s.pop();
    ...
    public Buffer writeString(String string, int beginIndex, int endIndex, Charset charset) {
        if (string == null) {
            ...
            byte[] data2 = string.substring(beginIndex, endIndex).getBytes(charset);
            return write(data2, 0, data2.length);
        }
    }
    ...
    public Buffer write(byte[] source, int offset, int byteCount) {
        if (source != null) {
            ...
            while (offset < limit) {
                ...
                System.arraycopy(source, offset, tail.f16data, tail.limit, toCopy);
                offset += toCopy;
                tail.limit += toCopy;
            }
    ...
    public int write(ByteBuffer source) throws IOException {
        if (source != null) {
            ...
            while (remaining > 0) {
                ...
                source.get(tail.f16data, tail.limit, toCopy);
                remaining -= toCopy;
                tail.limit += toCopy;
            }
            this.size += (long) byteCount;
    ...
    public Buffer writeShort(int s) {
        ...
        int limit2 = limit + 1;
        data2[limit] = (byte) ((s >>> 8) & 255);
        int limit3 = limit2 + 1;
        data2[limit2] = (byte) (s & 255);
        tail.limit = limit3;
        this.size += 2;
        return this;
    }
    ...
    public Buffer writeInt(int i) {
        ...
        int limit = tail.limit;
        int limit2 = limit + 1;
        data2[limit] = (byte) ((i >>> 24) & 255);
        int limit3 = limit2 + 1;
        data2[limit2] = (byte) ((i >>> 16) & 255);
        int limit4 = limit3 + 1;
        data2[limit3] = (byte) ((i >>> 8) & 255);
        int limit5 = limit4 + 1;
        data2[limit4] = (byte) (i & 255);
        tail.limit = limit5;
        this.size += 4;
        return this;
    }
    ...
    public Buffer writeLong(long v) {
        ...
        int limit = tail.limit;
        int limit2 = limit + 1;
        data2[limit] = (byte) ((int) ((v >>> 56) & 255));
        int limit3 = limit2 + 1;
        data2[limit2] = (byte) ((int) ((v >>> 48) & 255));
        int limit4 = limit3 + 1;
        data2[limit3] = (byte) ((int) ((v >>> 40) & 255));
        int limit5 = limit4 + 1;
        data2[limit4] = (byte) ((int) ((v >>> 32) & 255));
        int limit6 = limit5 + 1;
        data2[limit5] = (byte) ((int) ((v >>> 24) & 255));
        int limit7 = limit6 + 1;
        data2[limit6] = (byte) ((int) ((v >>> 16) & 255));
        int limit8 = limit7 + 1;
        data2[limit7] = (byte) ((int) ((v >>> 8) & 255));
        int limit9 = limit8 + 1;
        data2[limit8] = (byte) ((int) (v & 255));
        tail.limit = limit9;
        this.size += 8;
        return this;
    }
    ...
    private ByteString digest(String algorithm) {
        try {
            ...
            if (this.head != null) {
                messageDigest.update(this.head.f16data, this.head.pos, this.head.limit - this.head.pos);
                for (Segment s = this.head.next; s != this.head; s = s.next) {
                    messageDigest.update(s.f16data, s.pos, s.limit - s.pos);
                }
            }
    ...
    private ByteString hmac(String algorithm, ByteString key) {
        try {
            ...
            if (this.head != null) {
                mac.update(this.head.f16data, this.head.pos, this.head.limit - this.head.pos);
                for (Segment s = this.head.next; s != this.head; s = s.next) {
                    mac.update(s.f16data, s.pos, s.limit - s.pos);
                }
            }
    ...
    public boolean equals(Object o) {
        ...
        while (pos < this.size) {
            ...
            while (((long) i) < count) {
                int posA2 = posA + 1;
                int posB2 = posB + 1;
                if (sa.f16data[posA] != sb.f16data[posB]) {
                    return false;
                }
                i++;
                posA = posA2;
    ...
    public int hashCode() {
        ...
        do {
            for (int pos = s.pos; pos < s.limit; pos++) {
                result = (result * 31) + s.f16data[pos];
            }
            s = s.next;
        } while (s != this.head);
        return result;
