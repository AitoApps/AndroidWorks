...
public final class InflaterSource implements Source {
        ...
        if (byteCount < 0) {
            ...
            while (true) {
                ...
                try {
                    ...
                    int bytesInflated = this.inflater.inflate(tail.f16data, tail.limit, (int) Math.min(byteCount, (long) (8192 - tail.limit)));
                    if (bytesInflated > 0) {
    ...
    public boolean refill() throws IOException {
        ...
        if (this.inflater.getRemaining() != 0) {
            ...
            this.inflater.setInput(head.f16data, head.pos, this.bufferBytesHeldByInflater);
            return false;
        }
    }
