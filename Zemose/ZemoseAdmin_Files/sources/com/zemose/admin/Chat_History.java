        ...
        this.send.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                if (Chat_History.this.chatbox.getText().toString().equalsIgnoreCase("")) {
                    Toasty.info(Chat_History.this.getApplicationContext(), "Please enter message", 0).show();
                    ...
                    Toasty.info(Chat_History.this.getApplicationContext(), "Please make sure your internet connection is active", 0).show();
                }
            }
        });
            ...
            public void onFailure(Call call, IOException e) {
                Chat_History.this.runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        Toasty.info(Chat_History.this.getApplicationContext(), "Goof Please try later", 0).show();
                    }
                });
            }
                    ...
                    public void run() {
                        try {
                            ...
                            if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("No")) {
                                Toasty.info(Chat_History.this.getApplicationContext(), "Please try later", 0).show();
