            ...
            client.newCall(builder.url(sb.toString()).post(body).build()).enqueue(new Callback() {
                public void onFailure(Call call, IOException e) {
                    Regional_Heads.this.runOnUiThread(new Runnable() {
                        public void run() {
                            Regional_Heads.this.nodata.setVisibility(0);
                            Regional_Heads.this.loading.setVisibility(8);
                            Regional_Heads.this.recylerview.setVisibility(8);
                        }
                    });
                }
                        ...
                        public void run() {
                            try {
                                ...
                                if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("No")) {
                                    ...
                                    Regional_Heads.this.loading.setVisibility(8);
                                    Regional_Heads.this.recylerview.setVisibility(8);
                                    Toasty.info(Regional_Heads.this.getApplicationContext(), "Please contact admin", 0).show();
                                    ...
                                    Regional_Heads.this.loading.setVisibility(8);
                                    Regional_Heads.this.recylerview.setVisibility(0);
                                    Regional_Heads.this.listAdapter.notifyDataSetChanged();
                                } else {
                                    Regional_Heads.this.nodata.setVisibility(0);
                                    Regional_Heads.this.loading.setVisibility(8);
                                    Regional_Heads.this.recylerview.setVisibility(8);
                                    Toasty.info(Regional_Heads.this.getApplicationContext(), "Please try later", 0).show();
                                }
                            } catch (Exception e) {
                                Regional_Heads.this.nodata.setVisibility(0);
                                Regional_Heads.this.loading.setVisibility(8);
