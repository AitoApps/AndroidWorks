...
public class Suppliers_List extends AppCompatActivity {
    ...
    public void get_suppliers() {
        try {
            ...
            sb.append("appadmin/getsupplier_list");
            client.newCall(builder.url(sb.toString()).post(body).build()).enqueue(new Callback() {
                public void onFailure(Call call, IOException e) {
                    Suppliers_List.this.runOnUiThread(new Runnable() {
                        public void run() {
                            Suppliers_List.this.nodata.setVisibility(0);
                            Suppliers_List.this.loading.setVisibility(8);
                            Suppliers_List.this.recylerview.setVisibility(8);
                        }
                    });
                }
                        ...
                        public void run() {
                            try {
                                ...
                                if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("No")) {
                                    ...
                                    Suppliers_List.this.loading.setVisibility(8);
                                    Suppliers_List.this.recylerview.setVisibility(8);
                                    Toasty.info(Suppliers_List.this.getApplicationContext(), "Please contact admin", 0).show();
                                    ...
                                    Suppliers_List.this.loading.setVisibility(8);
                                    Suppliers_List.this.recylerview.setVisibility(0);
                                    Suppliers_List.this.listAdapter.notifyDataSetChanged();
                                } else {
                                    Suppliers_List.this.nodata.setVisibility(0);
                                    Suppliers_List.this.loading.setVisibility(8);
                                    Suppliers_List.this.recylerview.setVisibility(8);
                                    Toasty.info(Suppliers_List.this.getApplicationContext(), "Please try later", 0).show();
                                }
                            } catch (Exception e) {
                                Suppliers_List.this.nodata.setVisibility(0);
                                Suppliers_List.this.loading.setVisibility(8);
