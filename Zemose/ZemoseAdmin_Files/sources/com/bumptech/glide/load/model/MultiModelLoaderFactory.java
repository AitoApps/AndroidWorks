...
public class MultiModelLoaderFactory {
    ...
    public MultiModelLoaderFactory(@NonNull Pool<List<Throwable>> throwableListPool2) {
        this(throwableListPool2, DEFAULT_FACTORY);
    }

    @VisibleForTesting
    MultiModelLoaderFactory(@NonNull Pool<List<Throwable>> throwableListPool2, @NonNull Factory factory2) {
