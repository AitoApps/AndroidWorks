    ...
    public void preFill(Builder... bitmapAttributeBuilders) {
        ...
        for (int i = 0; i < bitmapAttributeBuilders.length; i++) {
            ...
            if (builder.getConfig() == null) {
                builder.setConfig((this.defaultFormat == DecodeFormat.PREFER_ARGB_8888 || this.defaultFormat == DecodeFormat.PREFER_ARGB_8888_DISALLOW_HARDWARE) ? Config.ARGB_8888 : Config.RGB_565);
            }
