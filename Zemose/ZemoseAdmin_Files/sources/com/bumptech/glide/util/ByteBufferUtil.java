...
public final class ByteBufferUtil {
    ...
    public static void toStream(@NonNull ByteBuffer byteBuffer, @NonNull OutputStream os) throws IOException {
        ...
        if (safeArray != null) {
            os.write(safeArray.f12data, safeArray.offset, safeArray.offset + safeArray.limit);
            return;
        }
    ...
    public static byte[] toBytes(@NonNull ByteBuffer byteBuffer) {
        SafeArray safeArray = getSafeArray(byteBuffer);
        if (safeArray != null && safeArray.offset == 0 && safeArray.limit == safeArray.f12data.length) {
