...
public class Registry {
    ...
    public <Data, TResource, Transcode> LoadPath<Data, TResource, Transcode> getLoadPath(@NonNull Class<Data> dataClass, @NonNull Class<TResource> resourceClass, @NonNull Class<Transcode> transcodeClass) {
        ...
        if (result == null) {
            ...
            if (decodePaths.isEmpty()) {
                ...
                LoadPath<Data, TResource, Transcode> loadPath = new LoadPath<>(dataClass, resourceClass, transcodeClass, decodePaths, this.throwableListPool);
                result = loadPath;
            }
    ...
    private <Data, TResource, Transcode> List<DecodePath<Data, TResource, Transcode>> getDecodePaths(@NonNull Class<Data> dataClass, @NonNull Class<TResource> resourceClass, @NonNull Class<Transcode> transcodeClass) {
        ...
        for (Class<TResource> registeredResourceClass : this.decoderRegistry.getResourceClasses(cls, resourceClass)) {
            for (Class<Transcode> registeredTranscodeClass : this.transcoderRegistry.getTranscodeClasses(registeredResourceClass, transcodeClass)) {
                ...
                DecodePath<Data, TResource, Transcode> path = new DecodePath<>(dataClass, registeredResourceClass, registeredTranscodeClass, this.decoderRegistry.getDecoders(cls, registeredResourceClass), this.transcoderRegistry.get(registeredResourceClass, registeredTranscodeClass), this.throwableListPool);
    ...
    @NonNull
    public <X> Encoder<X> getSourceEncoder(@NonNull X data2) throws NoSourceEncoderAvailableException {
        Encoder<X> encoder = this.encoderRegistry.getEncoder(data2.getClass());
        if (encoder != null) {
            return encoder;
        }
        throw new NoSourceEncoderAvailableException(data2.getClass());
    }

    @NonNull
    public <X> DataRewinder<X> getRewinder(@NonNull X data2) {
        return this.dataRewinderRegistry.build(data2);
    }
