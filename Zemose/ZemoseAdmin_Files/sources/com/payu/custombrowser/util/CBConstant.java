...
public interface CBConstant {
    ...
    public static final int CHECK_CATCH_ALL_JS_ENABLE_JS_STATUS = 3;
    ...
    public static final String CHROME_NOT_PRESENT = "CHROME_NOT_PRESENT";
    public static final int CHROME_NOT_PRESENT_CODE = 103;
    public static final String COMMAND = "command";
    public static final int CONFIRM_TXN_SNOOZE = 14;
    public static final String CURRENT_URL = "currentUrl";
    public static final String DEEP_LINK_INTENT_URI = "intent://";
    ...
    public static final String DEVICE_NOT_SUPPORTED_OR = "Device not supported or ";
    public static final int DEVICE_NOT_SUPPORTED_OR_MODULE_NOT_IMPORTED = 1022;
    public static final String DEVICE_NOT_SUPPORTED_OR_MODULE_NOT_IMPORTED_MSG = "Device not supported or com.payu.samsungpay is missing";
    ...
    public static final int MERCHANT_URL_LOADING_TIMEOUT = 5000;
    ...
    public static final String MSG_OTP_Filled = "OTP securely filled by PayU";
    public static final String NB = "nb";
    public static final String NOTIFICATION_CHANNEL_DESCRIPTION = "No Internet Notification";
    public static final String NOTIFICATION_CHANNEL_ID = "payu_surepay_channel";
    public static final String NOTIFICATION_CHANNEL_NAME = "No Internet Notification";
    public static final int NOT_CONFIRM_SNOOZE = 15;
    public static final String ORDER_DETAILS = "order_details";
    public static final String OS_NOT_SUPPORTED = "OS_NOT_SUPPORTED";
    public static final int OS_NOT_SUPPORTED_CODE = 101;
    ...
    public static final String POST_DATA_OR_HTML_DATA_NOT_PRESENT = "POST_DATA_OR_HTML_DATA_NOT_PRESENT";
    public static final int POST_DATA_OR_HTML_DATA_NOT_PRESENT_CODE = 104;
    ...
    public static final String PRODUCTION_URL = "https://cbjs.payu.in/js/sdk_js/v3/";
    ...
    public static final String RESPONSE_NOT_PRESENT = "RESPONSE_NOT_PRESENT";
    public static final int RESPONSE_NOT_PRESENT_CODE = 102;
    public static final int RETRY_NOW = 12;
    public static final String S2SPAYUID = "cookiePayuId";
    public static final String S2SREPLAYURL = "replayUrl";
    public static final String S2S_RETRY_URL = "s2sRetryUrl";
    ...
    public static final String SUREPAY_S2S = "surepay_s2s";
    public static final String SURL = "surl";
    public static final String TEST_PAYMENT_URL = "https://mobiletest.payu.in/_payment";
    public static final String TEST_URL = "https://cbstatic.payu.in/js/sdk_js/v3/";
