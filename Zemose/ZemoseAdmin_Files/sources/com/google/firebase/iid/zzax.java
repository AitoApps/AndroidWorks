...
final class zzax {
    ...
    static zzax zzi(String str) {
        ...
        try {
            ...
            return new zzax(jSONObject.getString("token"), jSONObject.getString("appVersion"), jSONObject.getLong(PayUmoneyConstants.LAST_USED_SESSION_TIMESTAMP));
    ...
    static String zza(String str, String str2, long j) {
        try {
            ...
            jSONObject.put(PayUmoneyConstants.LAST_USED_SESSION_TIMESTAMP, j);
