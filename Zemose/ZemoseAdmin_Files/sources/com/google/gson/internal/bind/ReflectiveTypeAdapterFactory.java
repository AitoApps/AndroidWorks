...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private BoundField createBoundField(Gson context, Field field, String name, TypeToken<?> fieldType, boolean serialize, boolean deserialize) {
        ...
        AnonymousClass1 r0 = new BoundField(name, serialize, deserialize) {
            /* access modifiers changed from: 0000 */
            ...
            while (i < length) {
                ...
                if (serialize || deserialize) {
                    ...
                    while (i2 < fieldNames.size()) {
                        ...
                        Field field2 = field;
                        previous = previous2 == null ? (BoundField) result.put(name2, createBoundField(context, field, name2, TypeToken.get(fieldType), serialize2, deserialize)) : previous2;
                        i2 = i3 + 1;
