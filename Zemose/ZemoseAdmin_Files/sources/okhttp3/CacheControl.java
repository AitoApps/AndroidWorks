...
public final class CacheControl {
    ...
    public static CacheControl parse(Headers headers) {
        ...
        boolean immutable4 = immutable2;
        if (!canUseHeaderValue) {
            headerValue2 = null;
        }
        CacheControl cacheControl = new CacheControl(noCache2, noStore3, maxAgeSeconds2, sMaxAgeSeconds2, isPrivate2, isPublic2, mustRevalidate2, maxStaleSeconds2, minFreshSeconds2, onlyIfCached2, noTransform2, immutable4, headerValue2);
        return cacheControl;
    }
