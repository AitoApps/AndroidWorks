...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x003e, code lost:
        return false;
     */
    private synchronized boolean send(ByteString data2, int formatOpcode) {
        if (!this.failed) {
            if (!this.enqueuedClose) {
                if (this.queueSize + ((long) data2.size()) > MAX_QUEUE_SIZE) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x005d, code lost:
        if ((r0 instanceof okhttp3.internal.ws.RealWebSocket.Message) == false) goto L_0x008c;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x005f, code lost:
        r5 = ((okhttp3.internal.ws.RealWebSocket.Message) r0).f13data;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x008e, code lost:
        if ((r0 instanceof okhttp3.internal.ws.RealWebSocket.Close) == false) goto L_0x00a9;
     */
