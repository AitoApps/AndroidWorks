            ...
            client.newCall(builder.url(sb.toString()).post(body).build()).enqueue(new Callback() {
                public void onFailure(Call call, IOException e) {
                    Supplier_Product.this.runOnUiThread(new Runnable() {
                        public void run() {
                            Supplier_Product.this.nodata.setVisibility(View.VISIBLE);
                            Supplier_Product.this.loading.setVisibility(View.GONE);
                            Supplier_Product.this.recylerview.setVisibility(View.GONE);
                        }
                    });
                }
                        ...
                        public void run() {
                            try {
                                ...
                                if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("No")) {
                                    ...
                                    Supplier_Product.this.loading.setVisibility(View.GONE);
                                    Supplier_Product.this.recylerview.setVisibility(View.GONE);
                                    Toasty.info(Supplier_Product.this.getApplicationContext(), "Please contact admin", Toast.LENGTH_SHORT).show();
                                    ...
                                    Supplier_Product.this.loading.setVisibility(View.GONE);
                                    Supplier_Product.this.recylerview.setVisibility(View.VISIBLE);
                                    Supplier_Product.this.listAdapter.notifyDataSetChanged();
                                } else {
                                    Supplier_Product.this.nodata.setVisibility(View.VISIBLE);
                                    Supplier_Product.this.loading.setVisibility(View.GONE);
                                    Supplier_Product.this.recylerview.setVisibility(View.GONE);
                                    Toasty.info(Supplier_Product.this.getApplicationContext(), "Please try later", Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                                Supplier_Product.this.nodata.setVisibility(View.VISIBLE);
                                Supplier_Product.this.loading.setVisibility(View.GONE);
