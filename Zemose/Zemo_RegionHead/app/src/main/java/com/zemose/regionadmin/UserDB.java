...
public class UserDB extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "zemose_adminfgdf";
    ...
    public void addregion(String regionheadId1, String regionId1, String regionName1,String headname1) {
        try
        {
            deleteregion();
            ...
            values.put(regionName,regionName1);
            db.insert(TABLE_name1, null, values);
            db.close();
        }
        catch (Exception a){
            Log.w("sasasasa",Log.getStackTraceString(a));
        }
