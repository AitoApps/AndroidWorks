...
import com.zemose.regionadmin.Do_Payment;
...
public class Supplier_List_ForPayment_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Supplier_List_ForPayment_Adapter(AppCompatActivity activity2, List<Supplierlist_FeedItem> feedItems2) {
