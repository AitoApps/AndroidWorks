...
import com.zemose.admin.Payment_Approve;
...
public class PaymentApprove_ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PaymentApprove_ListAdapter(AppCompatActivity activity2, List<PaymentApprove_FeedItem> feedItems2) {
        ...
        builder.setMessage(message).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                if (PaymentApprove_ListAdapter.this.cd.isConnectingToInternet()) {
                    ...
                    Toasty.info(PaymentApprove_ListAdapter.this.context, Temp_Variable.nointernet, Toast.LENGTH_SHORT).show();
                }
            }
        });
                ...
                public void onFailure(Call call, IOException e) {
                    PaymentApprove_ListAdapter.this.activity.runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            Toasty.info(PaymentApprove_ListAdapter.this.context, "Please try later", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                        ...
                        public void run() {
                            try {
                                ...
                                if (new JSONObject(response.body().string()).getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("approve")) {
                                    Toasty.info(PaymentApprove_ListAdapter.this.context, "Approved", Toast.LENGTH_SHORT).show();
                                    ((Payment_Approve) PaymentApprove_ListAdapter.this.activity).removeitem(PaymentApprove_ListAdapter.this.pos);
                                    return;
                                }
                                Toasty.info(PaymentApprove_ListAdapter.this.context, "Unable to approve ! Please try later", Toast.LENGTH_SHORT).show();
                            } catch (Exception e) {
                            }
                        }
                    });
                        ...
                        public void run() {
                            try {
                                ...
                                if (new JSONObject(response.body().string()).getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("rejected")) {
                                    Toasty.info(PaymentApprove_ListAdapter.this.context, "Rejected", Toast.LENGTH_SHORT).show();
                                    ((Payment_Approve) PaymentApprove_ListAdapter.this.activity).removeitem(PaymentApprove_ListAdapter.this.pos);
                                    return;
                                }
                                Toasty.info(PaymentApprove_ListAdapter.this.context, "Unable to reject ! Please try later", Toast.LENGTH_SHORT).show();
                            } catch (Exception e) {
                            }
                        }
                    });
