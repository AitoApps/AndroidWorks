...
import com.zemose.admin.Order_Report;
...
public class Sna_ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Sna_ListAdapter(AppCompatActivity activity2, List<Sna_FeedItem> feedItems2) {
            ...
            try {
                ...
                viewHolder2.customer.setOnClickListener(new OnClickListener() {
                    public void onClick(View view) {
                        Object obj = Sna_ListAdapter.this.feedItems.get(position);
                        ((Order_Report) Sna_ListAdapter.this.activity).call(((Sna_FeedItem) Sna_ListAdapter.this.feedItems.get(position)).getcustomercontact());
                    }
                });
            } catch (Exception e) {
            }
