    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.addnew.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                Toast.makeText(Region_Management.this.getApplicationContext(), "Please select country list", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            client.newCall(builder.url(sb.toString()).post(body).build()).enqueue(new Callback() {
                public void onFailure(Call call, IOException e) {
                    Region_Management.this.runOnUiThread(new Runnable() {
                        public void run() {
                            Region_Management.this.nodata.setVisibility(View.VISIBLE);
                            Region_Management.this.loading.setVisibility(View.GONE);
                            Region_Management.this.recylerview.setVisibility(View.GONE);
                        }
                    });
                }
                        ...
                        public void run() {
                            try {
                                ...
                                if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("No")) {
                                    ...
                                    Region_Management.this.loading.setVisibility(View.GONE);
                                    Region_Management.this.recylerview.setVisibility(View.GONE);
                                    Toasty.info(Region_Management.this.getApplicationContext(), "Please contact admin", Toast.LENGTH_SHORT).show();
                                    ...
                                    Region_Management.this.loading.setVisibility(View.GONE);
                                    Region_Management.this.recylerview.setVisibility(View.VISIBLE);
                                    Region_Management.this.listAdapter.notifyDataSetChanged();
                                } else {
                                    Region_Management.this.nodata.setVisibility(View.VISIBLE);
                                    Region_Management.this.loading.setVisibility(View.GONE);
                                    Region_Management.this.recylerview.setVisibility(View.GONE);
                                    Toasty.info(Region_Management.this.getApplicationContext(), "Please try later", Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                    ...
                    Region_Management.this.runOnUiThread(new Runnable() {
                        public void run() {
                            try {
                                ...
                                if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("No")) {
                                    Toasty.info(Region_Management.this.getApplicationContext(), "Please check contact number", Toast.LENGTH_SHORT).show();
                                } else if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("got")) {
                                    JSONArray jsonarray = jo.getJSONArray("data");
