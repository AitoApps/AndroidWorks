            ...
            client.newCall(builder.url(sb.toString()).post(body).build()).enqueue(new Callback() {
                public void onFailure(Call call, IOException e) {
                    Requests.this.runOnUiThread(new Runnable() {
                        public void run() {
                            Requests.this.nodata.setVisibility(View.VISIBLE);
                            Requests.this.loading.setVisibility(View.GONE);
                            Requests.this.recylerview.setVisibility(View.GONE);
                        }
                    });
                }
                        ...
                        public void run() {
                            try {
                                ...
                                if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("No")) {
                                    ...
                                    Requests.this.loading.setVisibility(View.GONE);
                                    Requests.this.recylerview.setVisibility(View.GONE);
                                    Toasty.info(Requests.this.getApplicationContext(), "Please contact admin", Toast.LENGTH_SHORT).show();
                                    ...
                                    if (jsonarray.length() > 0) {
                                        ...
                                        Requests.this.loading.setVisibility(View.GONE);
                                        Requests.this.recylerview.setVisibility(View.VISIBLE);
                                    ...
                                    Requests.this.loading.setVisibility(View.GONE);
                                    Requests.this.recylerview.setVisibility(View.GONE);
                                    Toasty.info(Requests.this.getApplicationContext(), "Please try later", Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                                Requests.this.nodata.setVisibility(View.VISIBLE);
                                Requests.this.loading.setVisibility(View.GONE);
    ...
    public void show_requestconfirm(String reqid, int position) {
        ...
        update.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                Toasty.info(Requests.this.getApplicationContext(), "Please make sure your internet connection is active", Toast.LENGTH_SHORT).show();
            }
        });
        dialog1.show();
    }
                        ...
                        public void run() {
                            try {
                                ...
                                if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("No")) {
                                    ...
                                    Toasty.info(Requests.this.getApplicationContext(), "Updated", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toasty.info(Requests.this.getApplicationContext(), "Please try later", Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
