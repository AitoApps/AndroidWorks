        ...
        this.update.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                if (!Add_Region_Head.this.cd.isConnectingToInternet()) {
                    Toast.makeText(Add_Region_Head.this.getApplicationContext(), Temp_Variable.nointernet, Toast.LENGTH_SHORT).show();
                } else if (Add_Region_Head.this.headname.getText().toString().equalsIgnoreCase("")) {
                    Toast.makeText(Add_Region_Head.this.getApplicationContext(), "Please enter headname", Toast.LENGTH_SHORT).show();
                    Add_Region_Head.this.headname.requestFocus();
                } else if (Add_Region_Head.this.username.getText().toString().equalsIgnoreCase("")) {
                    Toast.makeText(Add_Region_Head.this.getApplicationContext(), "Please enter username", Toast.LENGTH_SHORT).show();
                    Add_Region_Head.this.username.requestFocus();
                } else if (Add_Region_Head.this.password.getText().toString().equalsIgnoreCase("")) {
                    Toast.makeText(Add_Region_Head.this.getApplicationContext(), "Please enter password", Toast.LENGTH_SHORT).show();
                        ...
                        public void run() {
                            try {
                                ...
                                if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("No")) {
                                    Toasty.info(Add_Region_Head.this.getApplicationContext(), "Please contact admin", Toast.LENGTH_SHORT).show();
                                } else if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("exit")) {
                                    Toasty.info(Add_Region_Head.this.getApplicationContext(), "Username already exist", Toast.LENGTH_SHORT).show();
                                } else if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("Update")) {
                                    Toasty.info(Add_Region_Head.this.getApplicationContext(), "Updated", Toast.LENGTH_SHORT).show();
                                    Add_Region_Head.this.finish();
                                } else {
                                    Toasty.info(Add_Region_Head.this.getApplicationContext(), "Please try later", Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                                Toasty.info(Add_Region_Head.this.getApplicationContext(), "Please try later", Toast.LENGTH_SHORT).show();
                            }
