        ...
        this.update.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                if (!Add_Region.this.cd.isConnectingToInternet()) {
                    Toast.makeText(Add_Region.this.getApplicationContext(), Temp_Variable.nointernet, Toast.LENGTH_SHORT).show();
                } else if (Add_Region.this.region.getText().toString().equalsIgnoreCase("")) {
                    Toast.makeText(Add_Region.this.getApplicationContext(), "Please enter region name", Toast.LENGTH_SHORT).show();
                        ...
                        public void run() {
                            try {
                                ...
                                if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("No")) {
                                    Toasty.info(Add_Region.this.getApplicationContext(), "Please contact admin", Toast.LENGTH_SHORT).show();
                                } else if (jo.getString(PayUmoneyConstants.MESSAGE).equalsIgnoreCase("Update")) {
                                    Toasty.info(Add_Region.this.getApplicationContext(), "Updated", Toast.LENGTH_SHORT).show();
                                    Add_Region.this.finish();
                                } else {
                                    Toasty.info(Add_Region.this.getApplicationContext(), "Please try later", Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                                Toasty.info(Add_Region.this.getApplicationContext(), "Please try later", Toast.LENGTH_SHORT).show();
                            }
