...
public class UserDatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "daydealudb";
    ...
    private static String CREATE_videoid_TABLE1 = "CREATE TABLE " + TABLE_name1 + "("+pkey +" INTEGER PRIMARY KEY AUTOINCREMENT,"+userid+" TEXT"+")";
    private static String CREATE_videoid_TABLE2 = "CREATE TABLE " + TABLE_name2+ "("+pkey +" INTEGER PRIMARY KEY AUTOINCREMENT,"+fcmid+" TEXT"+")";
