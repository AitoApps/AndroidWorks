...
public class ShopList extends AppCompatActivity {
    ...
    public void changeitem(int position, String sn1, String shopname1, String ownername1, String mobile1, String mobile2, String place1, String latitude1, String longtitude1, String imgsig1, String status1, String trust) {
        try {
            feedItems.remove(position);
            listAdapter.notifyDataSetChanged();
