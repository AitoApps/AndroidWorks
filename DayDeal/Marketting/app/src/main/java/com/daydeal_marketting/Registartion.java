...
public class Registartion extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.activity_registartion);
        ...
        register.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                if (!cd.isConnectingToInternet()) {
                    ...
                    Toasty.info(getApplicationContext(), "ദയവായി രജിസ്‌ട്രേഡ് മൊബൈല്‍ നമ്പര്‍ എന്റര്‍ ചെയ്യുക ", Toast.LENGTH_LONG).show();
                    name.requestFocus();
                } else {
    ...
    public class registration extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            try {
                ...
                String link= Temp.weblink +"registration_marketting.php";
