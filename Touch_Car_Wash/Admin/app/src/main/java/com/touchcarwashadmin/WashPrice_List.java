...
public class WashPrice_List extends AppCompatActivity {
    ...
    public int limit = 0;
    ListView list;
    public Washpricelist_ListAdapter listAdapter;
    ImageView nodata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listAdapter = new Washpricelist_ListAdapter(this, feedItems);
    ...
    public class loadstatus extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            ...
            try {
                String link=Temp.weblink +"getwashprices.php";
        ...
        public void onPostExecute(String result) {
            try {
                if (result.trim().contains(":%ok")) {
                    ...
                    int m = -1;
                    for (int i = 1; i <= k; i++) {
                        Washprice_FeedItem item = new Washprice_FeedItem();
                        m=m+1;
