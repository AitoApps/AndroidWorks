...
public class ColorPickerDialog {
    ...
    final View viewHue;
    final ColorPickerKotak viewSatVal;
    ...
    public ColorPickerDialog(final Context context, int color, OnColorPickerListener listener) {
        ...
        viewHue = view.findViewById(R.id.color_viewHue);
        viewSatVal = view.findViewById(R.id.color_viewSatBri);
        viewCursor = view.findViewById(R.id.color_cursor);
        viewOldColor = view.findViewById(R.id.color_warnaLama);
        viewNewColor = view.findViewById(R.id.color_warnaBaru);
        viewTarget = view.findViewById(R.id.color_target);
        viewContainer = view.findViewById(R.id.color_viewContainer);
        ...
        dialog = new AlertDialog.Builder(context)
                ...
                .setOnCancelListener(new OnCancelListener() {
                    // if img_moveback button is used, call img_moveback our listener.
