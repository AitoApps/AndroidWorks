...
import adapter.RechargeListAdapter;
...
public class Mk_Recharge extends AppCompatActivity {
    ...
    public int limit = 0;
    ListView list;
    public RechargeListAdapter listAdapter;
    ImageView nointernet;
    ProgressBar pb;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView((int) R.layout.activity_mk__recharge);
        ...
        listAdapter = new RechargeListAdapter(this, feedItems);
    ...
    public class loadlikes extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            try {
                String link=Tempvariable.weblink2+"getecrecharge.php";
