...
public class Get_verificationcode extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.activity_get_verificationcode);
    ...
    public class updateage extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            try {
                String link=Tempvariable.weblink+"getvcode.php";
