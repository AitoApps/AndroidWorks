...
import com.chintha_admin.Mk_Recharge;
...
public class RechargeListAdapter extends BaseAdapter {
    ...
    public String txtsn;
    public View views;
    public RechargeListAdapter(Activity activity2, List<Recharge_FeedItem> feedItems2) {
        activity = activity2;
        ...
        try {
            ...
            verify.setOnClickListener(new OnClickListener() {
                public void onClick(View arg0) {
                    ...
                    Recharge_FeedItem recharge_FeedItem = (Recharge_FeedItem) feedItems.get(position);
                    Recharge_FeedItem item = (Recharge_FeedItem) feedItems.get(position);
                    txtsn = item.getsn();
                    pos = position;
                    showalert1("Are you sure want to agree this coupon ?");
                }
            });
            delete.setOnClickListener(new OnClickListener() {
                public void onClick(View v) {
                    ...
                    txtsn = item.getsn();
                    pos = position;
                    showalert2("Are you sure want to DIS -DONT ALLOW agree this coupon ?");
                }
            });
        } catch (Exception a) {
        ...
        public void onPostExecute(String result) {
            if (pd != null || pd.isShowing()) {
                ...
                if (result.contains("ok")) {
                    Toast.makeText(context, "Agrreed", Toast.LENGTH_SHORT).show();
                    ((Mk_Recharge) activity).removeitem(pos);
                    return;
                }
