...
public class TextColorsList_Adapter extends Adapter<ViewHolder> {
    ...
    public List<TextColors_FeedItem> feedItems;
    private LayoutInflater inflater;
    public TextColorsList_Adapter(Activity activity2, List<TextColors_FeedItem> feedItems2) {
        activity = activity2;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        if (holder instanceof viewHolder) {
            try {
                TextColors_FeedItem item = (TextColors_FeedItem) feedItems.get(position);
                ...
                viewHolder2.color_picker_view.setOnClickListener(new OnClickListener() {
                    public void onClick(View view) {
                        TextColors_FeedItem item = (TextColors_FeedItem) feedItems.get(position);
                        Temp.textcolor=item.getColorcode();
