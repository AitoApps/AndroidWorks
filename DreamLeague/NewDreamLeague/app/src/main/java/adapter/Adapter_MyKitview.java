...
public class Adapter_MyKitview extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    ProgressDialog pb;
    public DB db;
    public Adapter_MyKitview(Activity activity, List<Feed_MyKits> feedItems) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            View v = LayoutInflater.from(context).inflate(R.layout.mykitview_customlayout, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof viewHolder) {
            ...
            try {
                final Feed_MyKits item = feedItems.get(position);
                final Adapter_MyKitview.viewHolder viewHolder = (Adapter_MyKitview.viewHolder) holder;
