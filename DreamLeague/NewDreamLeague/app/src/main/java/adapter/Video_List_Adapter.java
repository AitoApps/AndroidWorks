...
import com.dlkitmaker_feeds.Internet_Connectivity;
import com.dlkitmaker_feeds.R;
import com.dlkitmaker_feeds.Temp;
import com.dlkitmaker_feeds.VideoPlayer;
...
public class Video_List_Adapter extends BaseAdapter {
    ...
    public Video_List_Adapter(Activity activity2, List<videoList_Feed> feedItems2) {
        ...
        udb = new DB(context);
        cd=new Internet_Connectivity(context);
        face = Typeface.createFromAsset(context.getAssets(), "fonts/proximanormal.ttf");
        face1 = Typeface.createFromAsset(context.getAssets(), "fonts/proxibold.otf");
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item.getIsadshow()==0) {
            ...
            Builder builder = new Builder((Context) activity, "ca-app-pub-5517777745693327/4589123686");
