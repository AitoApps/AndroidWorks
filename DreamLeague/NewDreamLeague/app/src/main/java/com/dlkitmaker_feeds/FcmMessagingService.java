...
public class FcmMessagingService extends FirebaseMessagingService {
    ...
    public void generate_newstatus(){
        ...
        if (VERSION.SDK_INT < 26) {
            Notification notification = new Notification.Builder(this).setSmallIcon(R.drawable.smalllogo).setContentIntent(pendingIntent).setContent(contentView).build();
        ...
        else
        {
            ...
            Notification notification2 = new Notification.Builder(this, str).setSmallIcon(R.drawable.smalllogo).setContentIntent(pendingIntent).setContent(contentView).setPriority(0).build();
