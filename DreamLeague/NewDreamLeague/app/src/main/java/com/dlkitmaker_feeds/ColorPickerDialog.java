...
/**
 * Created by Jitesh Dalsaniya on 7/24/13.
 */
...
public class ColorPickerDialog {
     ...
     *            current color
     * @param listener
     *            an OnColorPickerListener, allowing you to get moveback error or
     */
    public ColorPickerDialog(final Context context, int color, OnColorPickerListener listener) {
        ...
        viewSatVal = (ColorPickerKotak) view.findViewById(R.id.color_viewSatBri);
        ...
        dialog = new AlertDialog.Builder(context)
                ...
                .setOnCancelListener(new OnCancelListener() {
                    // if moveback button is used, call moveback our listener.
