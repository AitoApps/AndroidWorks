...
import com.fishappadmin.Add_Advt;
...
public class Advt_ListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (item.getTypes().equalsIgnoreCase("1")) {
            adtype.setText("Fish");
        } else if (item.getTypes().equalsIgnoreCase("2")) {
            adtype.setText("Call");
        } else if (item.getTypes().equalsIgnoreCase("3")) {
            adtype.setText("Web");
        } else if (item.getTypes().equalsIgnoreCase("4")) {
            adtype.setText("Nothing");
        }
