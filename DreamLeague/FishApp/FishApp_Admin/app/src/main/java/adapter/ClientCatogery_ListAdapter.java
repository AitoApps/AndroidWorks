...
import com.fishappadmin.Add_Client_Catogery;
...
import data.ClientCatgery_FeedItem;
...
public class ClientCatogery_ListAdapter extends BaseAdapter {
    ...
    public List<ClientCatgery_FeedItem> feedItems;
    private LayoutInflater inflater;
    public String pcatid = "";
    ProgressDialog pd;
    int pos = 0;
    public ClientCatogery_ListAdapter(Activity activity2, List<ClientCatgery_FeedItem> feedItems2) {
        activity = activity2;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.custom_clientcatogery, null);
        }
        ...
        ClientCatgery_FeedItem item = (ClientCatgery_FeedItem) feedItems.get(position);
        ...
        Glide.with(context).load(Temp.weblink+"clientcatogery/"+item.getSn()+".png").apply(rep).transition(DrawableTransitionOptions.withCrossFade()).into(image);
        clients.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ClientCatgery_FeedItem clientCatgery_FeedItem = (ClientCatgery_FeedItem) feedItems.get(position);
                ClientCatgery_FeedItem item = (ClientCatgery_FeedItem) feedItems.get(position);
                Temp.clientcatsn = item.getSn();
                Temp.clientcatname = item.getCatogery();
                Intent i = new Intent(context, Clients.class);
        ...
        edit.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                Intent i = new Intent(context, Add_Client_Catogery.class);
                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                context.startActivity(i);
            }
        });
    ...
    public class delete_product extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            ...
            try {
                ...
                String link= Temp.weblink +"delete_clientcatogery.php";
        ...
        public void onPostExecute(String result) {
            if (pd != null || pd.isShowing()) {
                ...
                if (result.contains("ok")) {
                    ...
                    ((Client_Catogery) activity).removeitem(pos);
                    return;
                }
