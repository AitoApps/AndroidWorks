...
public class Image_viewer extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        face1 = Typeface.createFromAsset(getAssets(), "font/proxibold.otf");
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            public void run() {
                ...
                Glide.with(getApplicationContext()).asBitmap().load(Temp.img_link).apply(new RequestOptions().signature(new ObjectKey(Temp.imgsig))).into(new SimpleTarget<Bitmap>() {
